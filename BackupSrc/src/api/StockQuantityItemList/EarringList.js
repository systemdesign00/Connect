...
//const chainfilter =  findgold(orderList,key).map((items) => items.itemType) === 'Chain'
  ...
  return (
    ...
    <Box style={ {marginRight:10,marginLeft:20 ,marginBottom:50 }} >
      <Grid container justifyContent="center">
       ...
       <Grid container spacing={0.5} columns={{ xs: 4, sm: 4, md: 12 }}> 
        {
            findgold(orderList,key).filter(item => item.itemType.substring(0,7) === 'Earring').map((item) => ( 
    ...
    raised={state.raised} zdepth={state.shadow}
      ...
      <CardHeader
        avatar={
         <img src="https://img.icons8.com/external-flatart-icons-flat-flatarticons/48/null/external-earring-jewellery-flatart-icons-flat-flatarticons-7.png"/>
