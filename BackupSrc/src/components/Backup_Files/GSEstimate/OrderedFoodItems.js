...
<Divider/>
     ...
     <img width="35" height="35" src="https://img.icons8.com/wired/64/cash.png" alt="cash"/>
     </TableCell>
      <TableCell sx={{color: 'black',fontWeight: "600" }}>
    ...
    <TableCell sx={{color: 'black',fontWeight: "600"}}></TableCell>
      ...
      <TableCell></TableCell>
                   ...
                   <TableCell></TableCell>
     <TableCell sx={{ color: 'black', fontWeight:"600"}}>
     <img width="35" height="35" src="https://img.icons8.com/external-sbts2018-outline-color-sbts2018/100/external-tax-basic-ui-elements-2.2-sbts2018-outline-color-sbts2018.png" alt="external-tax-basic-ui-elements-2.2-sbts2018-outline-color-sbts2018"/>
     </TableCell>
      <TableCell sx={{color: 'black',fontWeight: "600" }}>
