...
{/*<Divider sx={{ bgcolor: "black" }}/> */}
  ...
  <Grid item xs={6}>
  <Typography variant="subtitle1" gutterBottom sx={{fontWeight: 'bold',color:'black'}}>
  Tax Invoice No : SJ-{values.id} / {lastFive} 
...
color: 'black',
fontWeight: "600"
  }}>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;{NumberFormat(Math.round((values.gTotal + makingcal + (Number(hallmarkingcal))) - Number(values.gCash)))}</TableCell>           
...
color: 'black',
fontWeight: "600"
  }}>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;{NumberFormat(Math.round((((values.gTotal + makingcal + (Number(hallmarkingcal)) - Number(values.gCash))) + (gstpertotal + gstpertotal)) ))}</StyledTableCell>           
