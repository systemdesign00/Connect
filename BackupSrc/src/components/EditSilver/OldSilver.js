...
const Todaysales = today.getDate() + "-"+ parseInt(today.getMonth()+1) +"-"+today.getFullYear();
    ...
    const oldaddFoodItem = oldfoodItem => {
        let x = {
            ...
            UOM:oldfoodItem.UOM,
            gstreduction:oldfoodItem.gstreduction,
...
const rates =   display.map(item => (item.rate))
  //oldfoodItem.foodItemNames = "OLD SILVER"
...
const c = (oldfoodItem.gstreduction * (a * b))/100
const total = (a * b) - c;
...
<TableContainer component={Paper}>
      <Table style={{ Width: 200 }} aria-label="customized table">
        <TableHead>
          <TableRow>
           ...
           {/* <TableCell >GST Reduction</TableCell>*/}
 ...
 <TextField focused size="small" style = {{width: 200}}inputProps={{ inputMode: 'numeric' }} label="ItemName" name="foodItemNames" id="foodItemNames" value={oldfoodItem.foodItemNames} onChange={handleInputChange} />
   ...
   {/* <TableCell>
       <form onSubmit={submitOrder}>
   <TextField focused size="small" style = {{width: 100}} inputProps={{ inputMode: 'numeric' }} label="GST -3%" name="gstreduction" id="gstreduction" value={oldfoodItem.gstreduction} onChange={handleInputChange} />
        </form>
   </TableCell> */ }   
