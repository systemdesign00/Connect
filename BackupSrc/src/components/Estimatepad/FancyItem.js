...
import { createAPIEndpoint, ENDPIONTS,deleteUserfancynon } from "../../api";
  ...
  useEffect(() => {
    const fetchData = async () => {
      try {
        ...
        //  fetch data
        const dataUrl = index.BASE_URL+`Sdfancystock`;
   ...
   <TableCell>
       ...
       */}
       <TableCell>
          ...
          <TextField focused size="small" style = {{width: 100}} inputProps={{ inputMode: 'numeric' }} label="ItemName" name="foodItemName" id="foodItemName" value={foodItem.foodItemName} onChange={handleInputChange} />
</form>
        ...
        <TableCell>
            <form onSubmit={submitOrder}>
         <TextField focused size="small" style = {{width: 100}} inputProps={{ inputMode: 'numeric' }} label="Price" name="tax" id="tax" value={foodItem.tax  ? foodItem.tax : 0}  onChange={handleInputChange} />
  </form>
   </TableCell>
