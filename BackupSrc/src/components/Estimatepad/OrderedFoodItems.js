      ...
      >
       ...
       <Table sx={{ minWidth: 650 }} size="small" aria-label="a dense table" className={classes.tablebill}>
                  ...
                  <TableRow>
                          ...
                          <TableCell></TableCell>
                          <TableCell></TableCell>
                          <TableCell><Typography variant="subtitle1" gutterBottom sx={{fontWeight: 'bold',color:'black'}}>
            ESTIMATE
                      ...
                      <TableRow>
                         ...
                         NAME:{values.fullName} </Typography> </TableCell>
                          <TableCell></TableCell>
                          <TableCell></TableCell>
                          <TableCell></TableCell>
                          <TableCell></TableCell>
                          ...
                          <TableCell></TableCell>
                          <TableCell><Typography variant="subtitle3" gutterBottom sx={{fontWeight: 'bold',color:'black'}}>
                          {new Date(values.hireDate).toLocaleDateString()} </Typography></TableCell>
                       
                      </TableRow>
               <TableRow>
                          <TableCell></TableCell>
               <TableCell><Typography variant="subtitle3" gutterBottom sx={{fontWeight: 'bold',color:'black'}}>
                        CITY:{values.city} </Typography> </TableCell>
                          <TableCell></TableCell>
                          <TableCell></TableCell>
                          <TableCell></TableCell>
                          <TableCell></TableCell>
                          ...
                          <TableCell></TableCell>
                          <TableCell><Typography variant="subtitle3" gutterBottom sx={{fontWeight: 'bold',color:'black'}}>
     GOLD: {values.goldrate}/GMS </Typography></TableCell>
                      </TableRow>
                      
                      <TableRow>
                          <TableCell></TableCell>
                          <TableCell><Typography variant="subtitle3" gutterBottom sx={{fontWeight: 'bold',color:'black'}}>
                          MOBILE:{values.mobile} </Typography> </TableCell>
                          <TableCell></TableCell>
                          <TableCell></TableCell>
                          <TableCell></TableCell>
                          <TableCell></TableCell>
                          ...
                          <TableCell></TableCell>
                          <TableCell> <Typography variant="subtitle3" gutterBottom sx={{fontWeight: 'bold',color:'black'}}>
     SILVER: {values.silverrate}/GMS  </Typography></TableCell>
...
{ordereditems.map((item,idx) => (
   wastageweight = Number(ordereditems.reduce((total, currentValue) => total = Number(total + currentValue.quantity),0)), 
    ...
    totalweigthpercent = Number(orderedFoodItemspercent.reduce((total, currentValue) => total = Number(total + currentValue.quantity),0)), 
           ...
           <TableCell sx={{border: "none",boxShadow: "none"}}>-</TableCell>
            <TableCell sx={{border: "none",boxShadow: "none"}}>{item.rate}</TableCell>
              <TableCell sx={{border: "none",boxShadow: "none"}}> {newval === item.type ? item.tax  :  item.tax +'%'}</TableCell>
...
{oldorderedFoodItems.map((item,idx) => (
            <TableRow key={item.id}>
              ...
              {/* <TableCell >-</TableCell>*/}
              <TableCell sx={{border: "none",boxShadow: "none"}}>{item.foodItemPrices}</TableCell>
...
<TableCell ></TableCell>
  ...
  <TableCell sx={{border: "none",boxShadow: "none"}}></TableCell>
    <TableCell >Total:</TableCell>
    <TableCell sx={{ color: 'green',fontWeight: "600"}} >{NumberFormat(values.gTotal )}</TableCell>
    </TableRow>
  ...
  <TableCell sx={{border: "none",boxShadow: "none"}}></TableCell>
    ...
    <TableCell sx={{ color: 'green',fontWeight: "600"}} >{NumberFormat((Number(values.gCash)))}</TableCell>
    </TableRow>
  ...
  <TableCell sx={{border: "none",boxShadow: "none"}}>
  GOLD:{ 
       Number(stockaddorderedFoodItems.reduce((total, currentValue) => total = Number(Number(total) + Number(currentValue.foodItemPrice)),0).toFixed(3))+
   Number(orderedFoodItemspercent.reduce((total, currentValue) => total = Number(Number(total) + Number(currentValue.foodItemPrice)),0).toFixed(3)) +
      Number(ordereditems.reduce((total, currentValue) => total = Number(Number(total) + Number(currentValue.foodItemPrice)),0).toFixed(3)) +
      Number(addorderedFoodItems.reduce((total, currentValue) => total = Number(Number(total) + Number(currentValue.foodItemPrice)),0).toFixed(3))+"G"
    }
  </TableCell>
  <TableCell sx={{border: "none",boxShadow: "none"}}></TableCell>
  <TableCell sx={{border: "none",boxShadow: "none"}}></TableCell>
 ...
 <TableCell >ATM/GPAY:</TableCell>
    <TableCell sx={{ color: 'green',fontWeight: "600"}} >{NumberFormat(Number(values.onlinecash))}</TableCell>
    </TableRow>
   
        
  <TableRow >
  <TableCell sx={{border: "none",boxShadow: "none"}}>
  SILVER:{Number(orderedFoodItems.reduce((total, currentValue) => total = Number(total + Number(currentValue.foodItemPrice)),0)).toFixed(3)+"G"}
  ...
  <TableCell sx={{border: "none",boxShadow: "none"}}></TableCell>
    ...
    <TableCell sx={{ color: 'red',fontWeight: "600"}} >{NumberFormat(values.gTotal - (Number(values.gCash) + Number(values.onlinecash)) + (Number(values.debitcash)) )}</TableCell>
    </TableRow>
