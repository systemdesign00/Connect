...
const taxRate = (oldfoodItem.foodItemPrices * oldfoodItem.taxs ) / 100;
oldfoodItem.Tfiness = Number((oldfoodItem.foodItemPrices * oldfoodItem.taxs ) / 100);
...
<TextField focused size="small" style = {{width: 200}} label="ItemName" name="foodItemNames" id="foodItemNames" value={oldfoodItem.foodItemNames} onChange={handleInputChange} />
  ...
  <TableCell>
        <form onSubmit={submitOrder}>
            <TextField focused size="small" style = {{width: 100}} inputProps={{ inputMode: 'numeric' }} label="Tfiness" name="Tfiness" id="Tfiness" value={oldfoodItem.Tfiness} onChange={handleInputChange} />
         </form>
          </TableCell> 
   <TableCell>
        <form onSubmit={submitOrder}>
