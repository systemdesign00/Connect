    ...
    const oldaddFoodItem = oldfoodItem => {
        let x = {
           ...
           taxs:oldfoodItem.taxs,
            ...
            subtotals:Number(oldfoodItem.foodItemPrices) * b || Number(Math.round(total))
        }
        setValues({
            ...values,
...
<TableContainer component={Paper}>
 ...
 <TextField focused fullWidth inputProps={{ inputMode: 'numeric' }} label="ItemName" name="foodItemNames" id="foodItemNames" value={oldfoodItem.foodItemNames} onChange={handleInputChange} />
  </form>
   </TableCell>
        <TableCell>
            <form onSubmit={submitOrder}>
              <TextField focused fullWidth inputProps={{ inputMode: 'numeric' }} label="Weight" name="foodItemPrices" id="foodItemPrices" value={oldfoodItem.foodItemPrices} onChange={handleInputChange} />
 </form>
       </TableCell>
