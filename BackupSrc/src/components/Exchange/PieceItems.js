...
const submitOrder = e => {
        e.preventDefault();
           ...
           addFoodItem(foodItem)
                createAPIEndpoint(ENDPIONTS.SALESPCSITEMS).salespcscreate(foodItem)
                    .then(res => {
                      //audio.play()
                       //resetFormControls();
                      // resetForm()
    ...
    return (
      ...
      <Table style={{ Width: 200 }} aria-label="customized table">
        ...
        <TableBody>
          ...
          <TextField focused  fullWidth label="ItemName" name="foodItemName" id="foodItemName" value={foodItem.foodItemName} onChange={handleInputChange} />
</form>
   </TableCell>
