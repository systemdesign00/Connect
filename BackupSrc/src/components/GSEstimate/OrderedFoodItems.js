...
fontWeight: "600"
     ...
     <SearchFoodItems
      ...
      <Table sx={{ minWidth: 550 }} size="small" aria-label="a dense table" className={classes.table}>
        <TableHead>
          <TableRow>
           <TableCell style={{ fontWeight: 'bold', fontSize: '1.2em' }}>Item</TableCell>
         
            <TableCell style={{ fontWeight: 'bold', fontSize: '1.2em' }}>Weight</TableCell>
            <TableCell style={{ fontWeight: 'bold', fontSize: '1.2em' }} >Wastage</TableCell>
             <TableCell style={{ fontWeight: 'bold', fontSize: '1.2em' }} >Rate</TableCell>
            <TableCell style={{ fontWeight: 'bold', fontSize: '1.2em' }}>+Rate</TableCell>
            <TableCell style={{ fontWeight: 'bold', fontSize: '1.2em' }}>Total</TableCell>
...
{ordereditems.map((item,idx) => (
   wastageweight = Number(ordereditems.reduce((total, currentValue) => total = Number(total + currentValue.quantity),0)), 
    ...
    totalweigthpercent = Number(orderedFoodItemspercent.reduce((total, currentValue) => total = Number(total + currentValue.quantity),0)), 
            ...
            <TableRow key={item.id}>
              <TableCell style={{ fontWeight: 'bold', fontSize: '1.2em' }}>{item.foodItemName}</TableCell>
             
              <TableCell style={{ fontWeight: 'bold', fontSize: '1.2em' }}>{item.foodItemPrice}</TableCell>
           <TableCell style={{ fontWeight: 'bold', fontSize: '1.2em' }}>-</TableCell>
            <TableCell style={{ fontWeight: 'bold', fontSize: '1.2em' }}>{item.rate}</TableCell>
              <TableCell style={{ fontWeight: 'bold', fontSize: '1.2em' }}> {newval === item.type ? item.tax  :  item.tax +'%'}</TableCell>
