...
let totalgst=  Number((values.gTotal + makingcal + (Number(hallmarkingcal))) - Math.round(values.gCash))       
...
<List dense={dense}>
 ...
 Taxable  Total  
  ...
  {NumberFormat((values.gTotal + makingcal + (Number(hallmarkingcal))) - values.gCash)}
...
color: 'black',
fontWeight: "600"
  }}>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;{NumberFormat(Math.round(values.gTotal + makingcal + (Number(hallmarkingcal))) - Math.round(values.gCash))}</TableCell>           
...
color: 'black',
fontWeight: "600"
  }}>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;{NumberFormat(Math.round(gstpertotal))}</TableCell>           
...
color: 'black',
fontWeight: "600"
  }}>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;{NumberFormat(Math.round((((values.gTotal + makingcal + (Number(hallmarkingcal)) -  Math.round(values.gCash))) + (gstpertotal + gstpertotal))))}</StyledTableCell>           
