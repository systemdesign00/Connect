...
const reset=()=>{
 ...
 stk = datas().reduce((total, currentValue) => total = total + Number(currentValue.itemWeight),0); 
        ...
        <TableBody>
          {datas().map(users => (
            ...
            {/*  <TableCell>
                  ...
                  <Chip label={  <Box fontWeight="fontWeightBold" fontSize={16}>{users.aadhaarnumber}</Box>} onClick={() => EditOrRemoves(users)} color="error" variant="outlined"/>
          </TableCell> */}
  ...
  <TableCell >   <Box fontWeight="fontWeightBold" fontSize={16}>{users.HUID}</Box></TableCell>              
              ...
              <TableCell > <Box fontWeight="fontWeightBold" fontSize={16}>22K</Box></TableCell>
          ...
          <TableCell>   <Box fontWeight="fontWeightBold" fontSize={16}>{users.itemWeight+"G"}</Box></TableCell>
           ...
           <TableCell >   <Box fontWeight="fontWeightBold" fontSize={16}>{users.finess}</Box></TableCell>
