  ...
  useEffect(() => {
    const fetchData = async () => {
      try {
        ...
        const dataUrl = `https://serdb.onrender.com/api/fancysilver`;
...
const wordify = (num) => {
   ...
   <TableCell>
       ...
       */}
        ...
        <TableCell>
            <form onSubmit={submitOrder}>
         <TextField focused size="small" style = {{width: 100}} inputProps={{ inputMode: 'numeric' }} label="tax" name="tax" id="tax" value={foodItem.tax  ? foodItem.tax : 0}  onChange={handleInputChange} />
  </form>
   </TableCell>
