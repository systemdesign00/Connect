       ...
       {/*   <TableCell sx={{ backgroundColor: "#c0c0c0"}} >Date</TableCell>*/}
        ...
        <TableRow >
         ...
         <TableCell ></TableCell>
            ...
            <TableCell sx={{ fontWeight:"bold"}}>{(Number(sumOfPreviousTfiness)+Number(sumOfPreviousTfinessrc)).toFixed(3)}G</TableCell>
...
<TableRow sx={{border: "none",
  ...
  boxShadow: "none"}}>Net WT:</TableCell>
      ...
      <TableCell sx={{fontWeight:"bold"}} > {(((Number(sumOfPreviousTfiness)+Number(sumOfPreviousTfinessrc))+Number(totalfiness))).toFixed(3)}G</TableCell>
...
<TableCell sx={{fontWeight:"bold"}}>{((Number(sumOfPreviousTfinessbottom)+Number(sumOfPreviousTfinessorc)).toFixed(3))}G</TableCell> 
      {
        /*
<TableCell sx={{fontWeight:"bold"}}>{
((Number(sumOfPreviousTfiness)+Number(totalfiness)) - Number(adjustfiness)) > 0 ?
(Number(adjustfiness) - (Number(sumOfPreviousTfiness)+Number(totalfiness))).toFixed(3) :
(Number(adjustfiness) - (Number(sumOfPreviousTfiness)+Number(totalfiness))).toFixed(3)
...
<TableCell sx={{fontWeight:"bold"}}>{(Number(sumOfPreviousTfinessbottom)+Number(sumOfPreviousTfinessorc)+(Number(adjustfiness))).toFixed(3)}G</TableCell> 
