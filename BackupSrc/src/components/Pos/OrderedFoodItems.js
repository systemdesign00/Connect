...
fontWeight: "600"
     ...
     <SearchFoodItems
      ...
      >
       ...
       <TableContainer >
       <Table sx={{ minWidth: 550 }} size="small" aria-label="a dense table" className={classes.tablebill}>
       <TableHead>
          <TableRow>
           <TableCell style={{ fontWeight: 'bold', fontSize: '1em' }}>{values.fullName}</TableCell>
           <TableCell ></TableCell>
            <TableCell style={{ fontWeight: 'bold', fontSize: '1em' }}>{values.mobile}</TableCell>
            <TableCell></TableCell>
              <TableCell style={{ fontWeight: 'bold', fontSize: '1em' }}>{values.city}</TableCell>
             <TableCell></TableCell>
     
              <TableCell ></TableCell>
               <TableCell style={{ fontWeight: 'bold', fontSize: '1em' }}>{new Date(values.hireDate).toLocaleDateString()}</TableCell>
                <TableCell ></TableCell>
               
          </TableRow>
          </TableHead>
        </Table>
      <Table sx={{ minWidth: 550 }} size="small" aria-label="a dense table" className={classes.table}>
        <TableHead>
          <TableRow>
           <TableCell style={{ fontWeight: 'bold', fontSize: '1.1em' }}>Item</TableCell>
         
            <TableCell style={{ fontWeight: 'bold', fontSize: '1.1em' }}>Weight</TableCell>
            <TableCell style={{ fontWeight: 'bold', fontSize: '1.1em' }} >Wastage</TableCell>
             <TableCell style={{ fontWeight: 'bold', fontSize: '1.1em' }} >Rate</TableCell>
            <TableCell style={{ fontWeight: 'bold', fontSize: '1.1em' }}>+Rate</TableCell>
        ...
        <TableBody>
          ...
          {stockaddorderedFoodItems.map((item,idx) => (
            <TableRow key={item.id}>
              <TableCell style={{ fontWeight: 'bold', fontSize: '1.1em' }}>{item.foodItemName}</TableCell>
                
              <TableCell style={{ fontWeight: 'bold', fontSize: '1.1em' }}>{item.foodItemPrice}</TableCell>
                         <TableCell style={{ fontWeight: 'bold', fontSize: '1.1em' }}>-</TableCell>
                <TableCell style={{ fontWeight: 'bold', fontSize: '1.1em' }}>{item.rate}</TableCell>
                     <TableCell style={{ fontWeight: 'bold', fontSize: '1.1em' }} >{item.tax}</TableCell>
     
              <TableCell style={{ fontWeight: 'bold', fontSize: '1.1em' }}> {NumberFormat(Math.round(item.subtotal)) }</TableCell>
...
{ordereditems.map((item,idx) => (
   wastageweight = Number(ordereditems.reduce((total, currentValue) => total = Number(total + currentValue.quantity),0)), 
    ...
    totalweigthpercent = Number(orderedFoodItemspercent.reduce((total, currentValue) => total = Number(total + currentValue.quantity),0)), 
           ...
           <TableCell style={{ fontWeight: 'bold', fontSize: '1.1em' }}>-</TableCell>
            <TableCell style={{ fontWeight: 'bold', fontSize: '1.1em' }}>{item.rate}</TableCell>
              <TableCell style={{ fontWeight: 'bold', fontSize: '1.1em' }}> {newval === item.type ? item.tax  :  item.tax +'%'}</TableCell>
...
<TableCell></TableCell>
                              ...
                              <TableCell></TableCell>
                              <TableCell></TableCell>
                              <TableCell style={{ fontWeight: 'bold', fontSize: '1.1em' }}>Grand Total</TableCell>
                             
  <TableCell style={{ fontWeight: 'bold', fontSize: '1.1em' }}>{NumberFormat(Math.round(newitem))}</TableCell>
            </TableRow>       
...
<TableCell></TableCell>
                              ...
                              <TableCell></TableCell>
                              <TableCell></TableCell>
                              <TableCell style={{ fontWeight: 'bold', fontSize: '1.1em' }}>VAT@3%</TableCell>
                             
  <TableCell style={{ fontWeight: 'bold', fontSize: '1.1em' }}> {NumberFormat(Number(newitem*3)/100)}</TableCell>
             </TableRow>   
...
<TableCell></TableCell>
                              ...
                              <TableCell></TableCell>
                              <TableCell></TableCell>
                              <TableCell style={{ fontWeight: 'bold', fontSize: '1.1em' }}>Net Value</TableCell>
                             
  <TableCell style={{ fontWeight: 'bold', fontSize: '1.1em' }}>{NumberFormat(Math.round(newitem)+Number(newitem*3)/100)}</TableCell>
             </TableRow>   
        
{oldorderedFoodItems.map((item,idx) => (
            <TableRow key={item.id}>
              <TableCell style={{ fontWeight: 'bold', fontSize: '1.1em' }}>{item.foodItemNames}</TableCell>
            
              <TableCell style={{ fontWeight: 'bold', fontSize: '1.1em' }}>{item.foodItemPrices}</TableCell>
              <TableCell style={{ fontWeight: 'bold', fontSize: '1.1em' }}>{item.quantitys}</TableCell>
               <TableCell style={{ fontWeight: 'bold', fontSize: '1.1em' }}>{item.rate}</TableCell>
                  <TableCell style={{ fontWeight: 'bold', fontSize: '1.1em' }}>-</TableCell>
...
<TableCell></TableCell>
                              ...
                              <TableCell></TableCell>
                              <TableCell></TableCell>
                              <TableCell style={{ fontWeight: 'bold', fontSize: '1.1em' }}>Sales Adjust</TableCell>
                             
  <TableCell style={{ fontWeight: 'bold', fontSize: '1.1em' }}>{NumberFormat(Math.round(news))}</TableCell>
            </TableRow> 
...
<TableCell></TableCell>
  ...
  <TableCell style={{ fontWeight: 'bold', fontSize: '1.1em' }}>{NumberFormat(Number(values.gTotal))}</TableCell>
            </TableRow> 
        </TableBody>
      </Table>
