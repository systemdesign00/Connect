    ...
    if (deleting) {
      intervalId = setInterval(() => {
        if (selectedIds.length === 0) {
          ...
          axios.delete(`https://serdb.onrender.com/api/DelInventory/${idToDelete}`)
            .then(response => {
      ...
      <TableContainer sx={{ maxHeight: 440 }}>
        <Table stickyHeader aria-label="sticky table">
          ...
          <TableRow>
            ...
            <StyledTableCell ><Box fontWeight="fontWeightBold" fontSize={15}>FINESS</Box></StyledTableCell>
          </TableRow>
          </TableHead>
          <TableBody>
            {apiData
              ...
              .map((row) => {
                ...
                <StyledTableCell > <Box fontWeight="fontWeightBold" fontSize={15}>{new Date(row.hireDate).toLocaleDateString()}</Box></StyledTableCell>
                 ...
                 <StyledTableCell> <Box fontWeight="fontWeightBold" fontSize={15}>{row.finess}</Box></StyledTableCell>
               </StyledTableRow>
                );
              })}
          </TableBody>
