...
const handleCheckboxChange = (id) => {
    ...
    if (deleting) {
      intervalId = setInterval(() => {
        if (selectedIds.length === 0) {
          ...
          axios.delete(`https://serdb.onrender.com/api/DelSilverstk/${idToDelete}`)
            .then(response => {
   ...
   const formattedDate = currentDate.toLocaleDateString('en-IN', {
    ...
    year: 'numeric',
            ...
            if (itemIndex !== -1) {
              ...
              try {
                const apiUrl = 'https://serdb.onrender.com/api/GstSilverStock'; // Replace with your API endpoint
  ...
  useEffect(() => {
    const fetchData = async () => {
      try {
        const apiUrl = 'https://serdb.onrender.com/api/DelSilverstk'; // Replace with your API endpoint
