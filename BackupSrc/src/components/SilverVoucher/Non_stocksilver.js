...
foodItem.foodItemName = "OLD SILVER";
      ...
      <Table style={{ Width: 200 }} aria-label="customized table">
        ...
        <TableBody>
          ...
          <form onSubmit={submitOrder}>
                 <TextField focused size="small" style = {{width: 150}}  label="foodItemName" name="foodItemName" id="foodItemName" value={foodItem.foodItemName} onChange={handleInputChange} />
         {/*   <Autocomplete
