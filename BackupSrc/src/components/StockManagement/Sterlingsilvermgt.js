...
export default function MaatalList() {
...
const navigate = useNavigate();
  const Fetchuser=()=>{
      createAPIEndpoint(ENDPIONTS.FANCYITEMS).primaryfetchAllsilveritems()
...
const handleSubmit = e => {
        e.preventDefault()
        if (validate()) {
            createAPIEndpoint(ENDPIONTS.FANCYITEMS).primarycreatesilveritem(values)
