...
<MDTypography display="block" variant="button" color="info" fontWeight="medium">
     {"Mobile Number: "}{values && values.mobile}
       ...
       <Grid item xs="auto">
        <MDTypography display="block" variant="button" color="info" fontWeight="medium">
     {"GSTIN : "}{values && values.secondarymobile}
</MDTypography>
             <Div></Div>
  <Div></Div>
       <MDTypography display="block" variant="button" color="info" fontWeight="medium">
 ...
 BANK INFO
      ...
      <MDTypography display="block" variant="button" color="info" fontWeight="medium">
     {"Account Holder Name : "}{values && values.acname}
</MDTypography>
 <Div></Div>
  <Div></Div>
   <MDTypography display="block" variant="button" color="info" fontWeight="medium">
     {"Account number : "}{values && values.acno}
</MDTypography>
 <Div></Div>
  <Div></Div>
   <MDTypography display="block" variant="button" color="info" fontWeight="medium">
     {"ISFC Code : "}{values && values.isfccode}
</MDTypography>
 <Div></Div>
  <Div></Div>
  <MDTypography display="block" variant="button" color="info" fontWeight="medium">
     {"Branch : "}{values && values.branch}
</MDTypography>
 <Div></Div>
  <Div></Div>
