...
const usersUrlfancynon = BASE_URL + "FancyStockitem";
const usersUrlnon = BASE_URL + "GstGoldStock";
const usersUrlsilvernon = BASE_URL + "GstSilverStock";
...
export const ENDPIONTS = {
  ...
  GOLDRESTORE: "DelInventory",
  SILVERRESTORE: "DelSilverstk",
  STERLINGRESTORE: "DelSterlingstk",
  ESTIMATERESTORE:"DelEstimatebill",
  WHOLESALERESTORE:"Delwholesalebill",
  GOLDPURCHASERESTORE:"DelGoldpurchase",
  SILVERPURCHASERESTORE:'DelSilverpurchase'
};
...
export const createAPIEndpoint = (endpoint) => {
  ...
  return {
    ...
    updateventor: (id, updatedRecord) =>
      axios.put(primaryurl + id, updatedRecord),
    ...
    primaryupdate: (id, updatedRecords) =>
      axios.put(primaryurl + id, updatedRecords),
    ...
    primaryupdateitem: (id, updatedRecords) =>
      axios.put(primaryurl + id, updatedRecords),
    ...
    primaryupdatesilveritem: (id, updatedRecords) =>
      axios.put(primaryurl + id, updatedRecords),
    ...
    primaryupdatefancyitem: (id, updatedRecords) =>
      axios.put(primaryurl + id, updatedRecords),
