...
let pendingcal = pending.reduce((total,currentValue) => total = total + currentValue,0) - (netpurchasewtps).toFixed(3);
...
<TableCell style={{ fontWeight: '600' }}>Whole Sales WT:</TableCell>
<TableCell style={{ fontWeight: '600', color: 'red' }}>{ netpurchasewtps.toFixed(3) + "G"} </TableCell>
                      </TableRow>
                    </TableBody>
                  </Table>
                </TableContainer>
