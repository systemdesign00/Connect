       ...
       createAPIEndpoint(ENDPIONTS.PURCHASESILVER).delete(id)
            ...
            .catch(err => console.log(err))
                   ...
                   if (itemIndex !== -1) {
                     ...
                     fetchAlled();
                     try {
                      const response =  axios.post('https://serdb.onrender.com/api/DelSilverpurchase', deletedItem);
...
useEffect(() => {
  ...
  axios.get('https://serdb.onrender.com/api/purchasesilver')
  ...
  if (deleting) {
    intervalId = setInterval(() => {
      if (selectedIds.length === 0) {
        ...
        axios.delete(`https://serdb.onrender.com/api/purchasesilver/${idToDelete}`)
          .then(response => {
