...
values.aadhaarnumber = searchSelectedCountry &&searchSelectedCountry.aadhaarnumber  || values.aadhaarnumber 
  ...
  <Grid item xs={6}>
    <TextField 
          ...
          startAdornment: (
            <InputAdornment position="start">
         <img width="20" height="20" src="https://img.icons8.com/fluency/48/gender-neutral-user.png" alt="gender-neutral-user"/>
            </InputAdornment>
          ),
        }} /> 
  </Grid>
...
<TextField 
 style ={{textTransform:'capitalize'}}
          ...
          startAdornment: (
            <InputAdornment position="start">
        <img width="20" height="20" src="https://img.icons8.com/color/48/city.png" alt="city"/>
            </InputAdornment>
          ),
        }} /> 
  </Grid>
  <Grid item xs={6}>
     ...
     InputProps={{
      startAdornment: (
        <InputAdornment position="start">
    <img width="20" height="20" src="https://img.icons8.com/color/48/callback.png" alt="callback"/>
        </InputAdornment>
      ),
    }} 
     />
...
<TextField 
          ...
          startAdornment: (
            <InputAdornment position="start">
        <img width="20" height="20" src="https://img.icons8.com/color/48/card-security.png" alt="card-security"/>
            </InputAdornment>
          ),
        }} /> 
  </Grid>
 ...
 <TextField fullWidth 
     ...
     InputProps={{
      startAdornment: (
        <InputAdornment position="start">
   <img width="20" height="20" src="https://img.icons8.com/color/48/identification-documents.png" alt="identification-documents"/>
        </InputAdornment>
      ),
    }} 
     />
...
<Grid container rowSpacing={1} columnSpacing={{ xs: 1, sm: 2, md: 3 }}>
  <Grid item xs={4}>
     <TextField   
          ...
          startAdornment: (
            <InputAdornment position="start">
           <img width="20" height="20" src="https://img.icons8.com/color/48/rupee--v1.png" alt="rupee--v1"/>
            </InputAdornment>
          ),
        }} />
...
/>
  ...
  <Grid item xs={4}>
   { Math.sign((values.gTotal - (Number(values.gCash) + Number(values.onlinecash)))) === 1 ?
      ...
      color='secondary'
          ...
          startAdornment: (
            <InputAdornment position="start">
         <img width="25" height="25" src="https://img.icons8.com/color/48/cash.png" alt="cash"/>
            </InputAdornment>
          ),
        }} /> :
         <TextField 
  ...
  <Grid item xs={4}>
    ...
    color='secondary'
          ...
          startAdornment: (
            <InputAdornment position="start">
       <img width="25" height="25" src="https://img.icons8.com/color/48/card-exchange--v1.png" alt="card-exchange--v1"/>
            </InputAdornment>
          ),
        }} /> :
        <TextField 
  ...
  <Grid item xs={4}>
    ...
    focused
      style ={{width: '90%'}}
          ...
          startAdornment: (
            <InputAdornment position="start">
        <img width="25" height="25" src="https://img.icons8.com/color/48/withdrawal-limit.png" alt="withdrawal-limit"/>
            </InputAdornment>
          ),
        }} /> :
        <TextField 
 ...
 <ButtonGroup size="small" aria-label="small button group">
   ...
   <Button
        ...
        >
          <RotateLeftOutlinedIcon  onClick={ getFreshModelObject }/>
        </Button>
      </ButtonGroup>
  <Box
          sx={{
