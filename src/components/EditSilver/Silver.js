...
const total = Number(foodItem.foodItemPrice * foodItem.rate);
...
const wordify = (num) => {
  ...
  <TextField focused size="small" style = {{width: 100}} inputProps={{ inputMode: 'numeric' }} label="taxs" name="taxs" id="taxs" value={oldfoodItem.taxs}  onChange={handleInputChange} />
     ...
     <TextField focused size="small"  InputProps={{
        ...
        }} style = {{width: 150}} label="Total" name="subtotal" id="subtotal" value={NumberFormat((total)) || NumberFormat(foodItem.subtotal)} onChange={handleInputChange} disabled/>
           </form>
             </TableCell> 
