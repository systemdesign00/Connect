...
let netpurchasewtp = purchasewtp.reduce((total,currentValue) => total = total + currentValue,0); */
  ...
  const adddatasilverfancy = searchListsfancysilver.map((item) =>
  ...
  const adddatapiece = searchListspiece.map((item) =>
  ...
  const oldsilvercalc = searchListssilver.map((item) =>
  ...
  //old purchase
  const oldcalgoldpurchase = productsoldgold.map((item) =>
    item.oldorderDetails.reduce(
      (total, currentValue) =>
        (total = total + Number(currentValue.foodItemPrices)),
      0
  ...
  const oldsilvercalcpurchase = productsoldsilver.map((item) =>
    item.oldorderDetails.reduce(
      (total, currentValue) =>
        (total = total + Number(currentValue.foodItemPrices)),
      0
                    ...
                    <Paper sx={{ width: "100%" }}>
                      ...
                      <TableContainer sx={{ maxHeight: 470 }}>
                        ...
                        >
                          ...
                          <TableBody>
                            {productsps.map((item) =>
                              item.orderDetailsilver.map((row) => (
                                <TableRow
                                  key={row.id}
                                  sx={{
                                    "&:last-child td, &:last-child th": {
