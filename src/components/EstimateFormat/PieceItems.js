...
const a = Number(foodItem.foodItemPrice) * Number(foodItem.quantity)
...
const wordify = (num) => {
   ...
   <TableCell>
       ...
       */}
        ...
        <TableCell>
            <form onSubmit={submitOrder}>
         <TextField focused size="small" style = {{width: 100}} disabled inputProps={{ inputMode: 'numeric' }} label="quantity" name="quantity" id="quantity" value={foodItem.quantity}  onChange={handleInputChange} />
  </form>
   </TableCell>
