            ...
            >
              ...
              <TableBody>
                <TableRow>
                  ...
                  >
                    {NumberFormat(
                      Math.round(newitem) + Number(newitem * 3) / 100
                    )}
                  </TableCell>
                  <TableCell
                    sx={{
              ...
              >
                <Tab
                  icon={
                    <>
                      {" "}
                      <img src="https://img.icons8.com/external-xnimrodx-blue-xnimrodx/32/null/external-stock-delivery-xnimrodx-blue-xnimrodx.png" />{" "}
                      <img src="https://img.icons8.com/arcade/32/null/percentage.png" />{" "}
                    </>
                  }
                  {...a11yProps(0)}
                />
                <Tab
                  icon={
                    <>
                      {" "}
                      <img src="https://img.icons8.com/external-xnimrodx-blue-xnimrodx/32/null/external-stock-delivery-xnimrodx-blue-xnimrodx.png" />{" "}
                      <img src="https://img.icons8.com/windows/32/null/decrease-decimal.png" />{" "}
                    </>
                  }
                  {...a11yProps(1)}
                />
                <Tab
                  icon={
                    <>
                      {" "}
                      <img src="https://img.icons8.com/external-xnimrodx-blue-xnimrodx/32/null/external-stock-delivery-xnimrodx-blue-xnimrodx.png" />{" "}
                      <img src="https://img.icons8.com/arcade/32/null/plus-math.png" />{" "}
                    </>
                  }
                  {...a11yProps(2)}
                />
          ...
          >
            ...
            <DialogContent dividers>
              <DialogContentText ref={componentRef}>
                <Box width="650px" height="500px" className="watermark">
