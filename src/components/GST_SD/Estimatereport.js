...
const componentRef = useRef();
const purchasewt =   searchListspurchase.map(item => (item.orderDetails.reduce((total, currentValue) => total = total + Number(currentValue.foodItemPrice),0)));
...
const purchasewtsil =   searchListspurchasesil.map(item => (item.orderDetailsilver.reduce((total, currentValue) => total = total + Number(currentValue.foodItemPrice),0)));
...
const purchasewtps =   searchListsp.map(item => (item.orderDetails.reduce((total, currentValue) => total = newval === currentValue.type ? total + Number(currentValue.foodItemPrice) : "",0)));
...
let netpurchasewtps = purchasewtps.reduce((total,currentValue) => total = total + currentValue,0);
  ...
  const adddatapercent =   searchLists.map(item => (item.orderPercent.reduce((total, currentValue) => total = total + Number(currentValue.foodItemPrice),0)));
...
const adddatawastage =   searchLists.map(item => (item.watageitems.reduce((total, currentValue) => total = total + Number(currentValue.foodItemPrice),0)));
...
const adddataadd =   searchLists.map(item => (item.addorderDetails.reduce((total, currentValue) => total = total + Number(currentValue.foodItemPrice),0)));
...
const adddataaddper =   searchLists.map(item => (item.stockaddorderDetails.reduce((total, currentValue) => total = total + Number(currentValue.foodItemPrice),0)));
...
const adddatasilver =   searchListssilver.map(item => (item.orderDetails.reduce((total, currentValue) => total = total + Number(currentValue.foodItemPrice),0)));
...
{/*OLD CALCULATION */ }
const oldcalgold =   searchLists.map(item => (item.oldorderDetails.reduce((total, currentValue) => total = total + Number(currentValue.foodItemPrices),0)));
...
let netweight = Number(savedatapercent) + Number(savedataadddatawastage) + Number(savedataadd) + Number(savedataaddper)
...
{/* starts here */}
{searchLists?.map(item => (item.stockaddorderDetails.map((row) => <TableRow
                        key={row.name}
                        sx={{ '&:last-child td, &:last-child th': { border: 0 } }}
                      >
                       <TableCell component="th" scope="row">{row.id}</TableCell>
...
<TableCell style={{ fontWeight: '600' }}>Net Stock WT:</TableCell>
     ...
     format="D-M-YYYY"
          label="Select Date"
          value={searchListssilver}
          onChange={(newValue) => setSearchKeyssilver(newValue.format("D-M-YYYY"))}
        />
      </DemoContainer>
    </LocalizationProvider>
                ...
                <TableContainer sx={{ maxHeight: 470 }}>
                  <Table stickyHeader aria-label="sticky table" className={classes.table}>
                    ...
                    <TableBody>
                      ...
                      {searchListssilver?.map(item => (item.orderDetails.map((row) => <TableRow
                        key={row.id}
                        sx={{ '&:last-child td, &:last-child th': { border: 0 } }}
                      >
                        <TableCell component="th" scope="row">{row.id}</TableCell>
...
<TableCell style={{ fontWeight: '600', color: 'red' }}>{roundTo2DecimalPoint(silverstk)+"G"} </TableCell>
                ...
                <TableContainer sx={{ maxHeight: 470 }}>
                  <Table stickyHeader aria-label="sticky table" className={classes.table}>
                    ...
                    <TableBody>
                      ...
                      {searchListssilver.map(item => (item.oldorderDetailsilver.map((row) => <TableRow
                        key={row.name}
                        sx={{ '&:last-child td, &:last-child th': { border: 0 } }}
                      >
                        <TableCell component="th" scope="row">{row.id}</TableCell>
 ...
 <LocalizationProvider dateAdapter={AdapterDayjs}>
     ...
     format="D-M-YYYY"
          label="Select Date"
          value={searchListsfancysilver}
          onChange={(newValue) => setSearchKeysfancysilver(newValue.format("D-M-YYYY"))}
        />
      </DemoContainer>
    </LocalizationProvider>
                ...
                <TableContainer sx={{ maxHeight: 470 }}>
                  <Table stickyHeader aria-label="sticky table" className={classes.table}>
                    ...
                    <TableBody>
                      ...
                      {searchListsfancysilver.map(item => (item.fancyitems.map((row) => <TableRow
                        key={row.id}
                        sx={{ '&:last-child td, &:last-child th': { border: 0 } }}
                      >
                        <TableCell component="th" scope="row">{row.id}</TableCell>
...
{searchListspiece.map(item => (item.pieceitems.map((row) => <TableRow
                        key={row.id}
                        sx={{ '&:last-child td, &:last-child th': { border: 0 } }}
                      >
...
<Grid xs={6}>
 <LocalizationProvider dateAdapter={AdapterDayjs}>
     ...
     format="D-M-YYYY"
          label="Select Date"
          value={searchListsp}
          onChange={(newValue) => setSearchKeysp(newValue.format("D-M-YYYY"))}
        />
      </DemoContainer>
    </LocalizationProvider>
   </Grid>
                  ...
                  <Table stickyHeader aria-label="sticky table" className={classes.table}>
                    ...
                    <TableCell component="th" scope="row">{item.shopName}</TableCell>
                      ...
                      <TableRow sx={{ '&:last-child td, &:last-child th': { border: 0 } }}>
                        ...
                        <TableCell style={{ fontWeight: '600', color: 'red' }}>{(Number(netpurchasewtp).toFixed(3) - netpurchasewtps).toFixed(3) + "G"}</TableCell>
<TableCell style={{ fontWeight: '600' }}>Purchase-S:</TableCell>
           <TableCell style={{ fontWeight: '600', color: 'red' }}>{Number(netpurchasewtps) - 0.0 + "G"} </TableCell>
                      </TableRow>
...
<Grid xs={6}>
 <LocalizationProvider dateAdapter={AdapterDayjs}>
     ...
     format="D-M-YYYY"
          label="Select Date"
          value={searchListspurchase}
          onChange={(newValue) => setSearchKeyspurchase(newValue.format("D-M-YYYY"))}
        />
      </DemoContainer>
    </LocalizationProvider>
   </Grid>
                ...
                <TableContainer sx={{ maxHeight: 470 }}>
                  <Table stickyHeader aria-label="sticky table" className={classes.table}>
                    ...
                    <TableBody>
                      ...
                      {searchListspurchase?.map(item => (item.orderDetails.map((row) => <TableRow
                        key={row.id}
                        sx={{ '&:last-child td, &:last-child th': { border: 0 } }}
                      >
                    <TableCell sx={{ backgroundColor: "#FDE37F"}} component="th" scope="row">{item.ventorName}</TableCell>
                        <TableCell sx={{ backgroundColor: "#FDE37F"}}>{item.hireDate}</TableCell>
...
<Grid xs={6}>
 <LocalizationProvider dateAdapter={AdapterDayjs}>
     ...
     format="D-M-YYYY"
          label="Select Date"
          value={searchListspurchasesil}
          onChange={(newValue) => setSearchKeyspurchasesil(newValue.format("D-M-YYYY"))}
        />
      </DemoContainer>
    </LocalizationProvider>
   </Grid>
...
{searchListspurchasesil?.map(item => (item.orderDetailsilver.map((row) => <TableRow
                        key={row.id}
                        sx={{ '&:last-child td, &:last-child th': { border: 0 } }}
                      >
