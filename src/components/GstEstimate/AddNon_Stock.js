...
const Todaysales = today.getDate() + "-"+ parseInt(today.getMonth()+1) +"-"+today.getFullYear();
 ...
 const validateForm = () => {
        ...
        //  temp.gCash = values.gCash != 0 ? "" : "This field is required.";
          //temp.HUID = foodItem.HUID != 0 ? "" : "This field is required.";
        ...
        e.preventDefault();
          if (validateForm()) {
               addFoodItem(foodItem)
                setNotify({ isOpen: true, message: 'Item  Added.',severity:"success" ,variant:'filled'});
...
/>
     {  /*   <TextField focused size="small" style = {{width: 100}}  label="foodItemName" name="foodItemName" id="foodItemName" value={foodItem.foodItemName} onChange={handleInputChange} />*/}
        ...
        <TableCell>
              <form onSubmit={submitOrder}>
         <TextField focused size="small" style = {{width: 100}} inputProps={{ inputMode: 'numeric' }} label="HUID" name="HUID" id="HUID" value={foodItem.HUID }  onChange={handleInputChange} />
