...
import sinestimate from '../../img/sinestimate.png'
...
let netcash = Number(values.cashreceived) + Number(values.cashreceivedonline);
let  cashtotaltax = (Number(values.cashreceived) + Number(values.cashreceivedonline)) * 0.01456;
let cashtotaltaxs = (Number(values.cashreceived) + Number(values.cashreceivedonline)) * 0.01456;
let totalcashtax = cashtotaltax + cashtotaltaxs;

let boardtotal = Number(values.gTotal) - Number(totalcashtax);
let totalboard = Number(boardtotal) -  Number(values.gTotal)
let findboard = totalcashtax - boardtotal

let overall = Number(values.gTotal) + Number(Math.abs(totalboard)) + Number(hallmarkingcal) 
            ...
            <InputAdornment position="start">
             ...
             value={dataadd.foodItemName} onChange={(e) => addhandle(e)} />
                ...
                : <Div >{adddataa.foodItemName}</Div>
                 ...
                 {/*  <TableCell><Div >{adddataa.HSN_Code}</Div></TableCell> */}
                   <TableCell><Div >{adddataa.Purity}</Div></TableCell>
                                        <TableCell >
                                            <>
{
                isEditingadd === idx ? 
            ...
            <InputAdornment position="start">
              <PaidOutlinedIcon />
                ...
                : <Div > {adddataa.foodItemPrice  }</Div>
                          ...
                          <TableCell>{adddataa.HUID}</TableCell>                 
            ...
            focused
             value={stockdataadd.foodItemName} onChange={(e) => stockaddhandle(e)} />
                ...
                : <Div >{stockadddataa.foodItemName}</Div>
                   ...
                   <TableCell><Div >{stockadddataa.Purity}</Div></TableCell>        
                                        <TableCell >
                                            <>
{
                 stockisEditingadd === idx ? 
         ...
         <TextField 
          ...
          focused
              ...
              <TableCell >{stockadddataa.HUID}</TableCell>
        <TableCell >
                                           {
                 stockisEditingadd === idx ? 
                   <form onSubmit={handleChange} className={classes.root} noValidate autoComplete="off">
          ...
          focused
           ...
           value={stockdataadd.rate} onChange={(e) => stockaddhandle(e)} />
                </form>
                : <Div > {stockadddataa.rate }</Div>
            }
              </TableCell>
                   <TableCell>
                { 
             ...
             stockisEditingadd ===idx ? stockadditem === stockdataadd.type ? Math.round(Number(stockdataadd.foodItemPrice) * (Number(stockdataadd.tax) + Number(stockdataadd.rate))) :  Math.round(Number(stockdataadd.foodItemPrice) *  Number(stockdataadd.rate))
                                            ...
                                            <>
{
 ...
 { 
             ...
             isEditing ===idx ? newval === data.type ?  Math.round(Number(data.foodItemPrice * data.rate) + Number(data.tax * data.foodItemPrice)) : Math.round((data.foodItemPrice * data.quantity * rates) - (data.discount * data.foodItemPrice * data.quantity * rates) / 100 + data.tax * (data.foodItemPrice * data.quantity * rates) / 100) 
...
<List dense={dense}>
  ...
  <Grid item xs>
 {NumberFormat(Number(hallmarkingcal))}
 </Grid>
</Grid>} />
<ListItemSecondaryAction>
 </ListItemSecondaryAction>
...
<List dense={dense}>
  ...
  <Grid item xs>
  {NumberFormat(Math.round(((values.gTotal + makingcal + (Number(hallmarkingcal))) + (gstpertotal + gstpertotal)) - Number(values.gCash)))}
  </Grid>
</Grid>} />
<ListItemSecondaryAction>
 </ListItemSecondaryAction>
                                            ...
                                            <>
{
  ...
  <TableCell sx={{
    ...
    color: 'black',
    fontWeight: "600"
  }} >{NumberFormat(Math.round(newitem + gsttotal))}</TableCell>
          <TableCell sx={{
...
color: 'black',
fontWeight: "600"
  }}>{NumberFormat((values.gTotal + gsttotal) )}</TableCell>
            </TableRow>
...
{
  Math.sign(((values.gTotal + gsttotal) - (Number(values.gCash) + Number(values.onlinecash)) + (Number(values.debitcash)) )) === -1 ? 
...
fontWeight: "600"
  }}>{NumberFormat((values.gTotal + gsttotal) - (Number(values.gCash) + Number(values.onlinecash)) + (Number(values.debitcash)) )}</TableCell>
      ...
      <TableBody>
           {stockaddorderedFoodItems.map((item,idx) => (
            <TableRow key={item.id}>
               <StyledTableCell >{idx + 1}</StyledTableCell>
                <StyledTableCell >{item.foodItemName +"("+item.HUID+")"}</StyledTableCell>
          ...
          
          {
            ...
            <TableRow key={adddataa.id}>
               <StyledTableCell >{idx + 1}</StyledTableCell>
                <StyledTableCell >{adddataa.foodItemName +"("+adddataa.HUID+")"}</StyledTableCell>
                <StyledTableCell >{adddataa.HSN_Code}</StyledTableCell>
                 <StyledTableCell >{adddataa.Purity}</StyledTableCell>
...
color: 'black',
fontWeight: "600"
  }}>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;{NumberFormat(Math.round(totalboard))}
...
color: 'black',
fontWeight: "600"
  }}>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;{NumberFormat(overall)}</TableCell>           
...
color: 'black',
fontWeight: "600"
  }}>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;{NumberFormat((cashtotaltaxs))}</TableCell>           
...
color: 'black',
fontWeight: "600"
  }}>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;{NumberFormat((cashtotaltax))}</TableCell>           
...
color: 'black',
fontWeight: "600"
  }}>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;{NumberFormat((Number(granttotalss)))}</StyledTableCell>           
...
<TableCell sx={{
    color: 'black',
fontWeight: "600"
  }}>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;{NumberFormat(Math.round(Number(oldcal)))}</TableCell>           
         </TableRow>
         <TableRow >
              &nbsp;&nbsp;
              &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
...
<TableCell sx={{
    color: 'black',
fontWeight: "600"
  }}>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;{NumberFormat(Math.abs(granttotalss)) - Number(Math.round(oldcal))}</TableCell>           
         </TableRow>
      </TableBody>
</Table>
