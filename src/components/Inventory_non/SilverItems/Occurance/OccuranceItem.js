...
useEffect(() => {
        createAPIEndpoint(ENDPIONTS.SDSILVERSTOCK).fetchAll()
            .then(res => {
...
const navigate = useNavigate();
  const Fetchuser=()=>{
      createAPIEndpoint(ENDPIONTS.SDSILVERSTOCK).primaryfetchAllsilveritems()
...
const handleSubmit = e => {
        e.preventDefault()
        if (validate()) {
            createAPIEndpoint(ENDPIONTS.SILVERITEMS).primarycreatesilveritem(values)
...
//values.joins = values.itemSize + "-" + "["+values.itemName+"]" + "-"+ values.itemType
...
//console.log(findOcc(datas(), key))
 const [openm, setOpenm] = React.useState(false);
  ...
  const  getOccurrencewt = (array, value) =>{
    return array.filter((v) => (v.itemName === value)).reduce((total, currentValue) => total = Number(total + Number(currentValue.itemWeight)),0);
  }  
  ...
  const employees = [
    {
      id: 1,
      fname: "ANKLET 5",
      ct: getOccurrencecount(datas(), "ANKLET 5"),
      wt:getOccurrencewt(datas(), "ANKLET 5")
    },
    {
      id: 2,
      fname: "ANKLET 5.5",
      ct: getOccurrencecount(datas(), "ANKLET 5.5"),
      wt: getOccurrencewt(datas(), "ANKLET 5.5"),
    },
    {
      id: 3,
      fname: "ANKLET 6",
      ct: getOccurrencecount(datas(), "ANKLET 6"),
      wt: getOccurrencewt(datas(), "ANKLET 6"),
    },
    {
      id: 4,
      fname: "ANKLET 6.5",
      ct: getOccurrencecount(datas(), "ANKLET 6.5"),
      wt: getOccurrencewt(datas(), "ANKLET 6.5"),
    },
    {
      id: 6,
      fname: "ANKLET 7",
      ct: getOccurrencecount(datas(), "ANKLET 7"),
      wt: getOccurrencewt(datas(), "ANKLET 7"),
    },
    {
      id: 8,
      fname: "ANKLET 7.5",
      ct: getOccurrencecount(datas(), "ANKLET 7.5"),
      wt: getOccurrencewt(datas(), "ANKLET 7.5"),
    },
    {
      id: 9,
      fname: "ANKLET 8",
      ct: getOccurrencecount(datas(), "ANKLET 8"),
      wt: getOccurrencewt(datas(), "ANKLET 8"),
    },
    {
      id: 10,
      fname: "ANKLET 8 PEARL+CHAIN",
      ct: getOccurrencecount(datas(), "ANKLET 8 PEARL+CHAIN"),
      wt: getOccurrencewt(datas(), "ANKLET 8 PEARL+CHAIN"),
    },
    {
      id: 11,
      fname: "ANKLET 8.5",
      ct: getOccurrencecount(datas(), "ANKLET 8.5"),
      wt: getOccurrencewt(datas(), "ANKLET 8.5"),
    },
    {
      id: 12,
      fname: "ANKLET 8.5 PEARL+CHAIN",
      ct: getOccurrencecount(datas(), "ANKLET 8.5 PEARL+CHAIN"),
      wt: getOccurrencewt(datas(), "ANKLET 8.5 PEARL+CHAIN"),
    },
    {
      id: 13,
      fname: "ANKLET 9",
      ct: getOccurrencecount(datas(), "ANKLET 9"),
      wt: getOccurrencewt(datas(), "ANKLET 9"),
    },
    {
      id: 14,
      fname: "ANKLET 9 CHAIN",
      ct: getOccurrencecount(datas(), "ANKLET 9 CHAIN"),
      wt:getOccurrencewt(datas(), "ANKLET 9 CHAIN")
    },
    {
      id: 15,
      fname: "ANKLET 9 MUTHU",
      ct: getOccurrencecount(datas(), "ANKLET 9 MUTHU"),
      wt: getOccurrencewt(datas(), "ANKLET 9 MUTHU"),
    },
    {
      id: 16,
      fname: "ANKLET 9.5",
      ct: getOccurrencecount(datas(), "ANKLET 9.5"),
      wt: getOccurrencewt(datas(), "ANKLET 9.5"),
    },
    {
      id: 17,
      fname: "ANKLET 9.5 CHAIN",
      ct: getOccurrencecount(datas(), "ANKLET 9.5 CHAIN"),
      wt: getOccurrencewt(datas(), "ANKLET 9.5 CHAIN"),
    },
    {
      id: 18,
      fname: "ANKLET 9.5 MUTHU",
      ct: getOccurrencecount(datas(), "ANKLET 9.5 MUTHU"),
      wt: getOccurrencewt(datas(), "ANKLET 9.5 MUTHU"),
    },
    {
      id: 8,
      fname: "ANKLET 10",
      ct: getOccurrencecount(datas(), "ANKLET 10"),
      wt: getOccurrencewt(datas(), "ANKLET 10"),
    },
    {
      id: 9,
      fname: "ANKLET 10 CHAIN",
      ct: getOccurrencecount(datas(), "ANKLET 10 CHAIN"),
      wt: getOccurrencewt(datas(), "ANKLET 10 CHAIN"),
    },
    {
      id: 10,
      fname: "ANKLET 10",
      ct: getOccurrencecount(datas(), "ANKLET 10 MUTHU"),
      wt: getOccurrencewt(datas(), "ANKLET 10 MUTHU"),
    },
    {
      id: 11,
      fname: "FANCY ANKLET 9",
      ct: getOccurrencecount(datas(), "FANCY ANKLET 9"),
      wt: getOccurrencewt(datas(), "FANCY ANKLET 9"),
    },
    {
      id: 12,
      fname: "FANCY ANKLET 9.5",
      ct: getOccurrencecount(datas(), "FANCY ANKLET 9.5"),
      wt: getOccurrencewt(datas(), "FANCY ANKLET 9.5"),
    },
    {
      id: 13,
      fname: "FANCY ANKLET 10",
      ct: getOccurrencecount(datas(), "FANCY ANKLET 10"),
      wt: getOccurrencewt(datas(), "FANCY ANKLET 10"),
    },
    {
      id: 17,
      fname: "FANCY ANKLET 10.5",
      ct: getOccurrencecount(datas(), "FANCY ANKLET 10.5"),
      wt: getOccurrencewt(datas(), "FANCY ANKLET 10.5"),
    },
    {
      id: 14,
      fname: "BOMBAY ANKLET 9",
      ct: getOccurrencecount(datas(), "BOMBAY ANKLET 9"),
      wt: getOccurrencewt(datas(), "BOMBAY ANKLET 9"),
    },
    {
      id: 15,
      fname: "BOMBAY ANKLET 9.5",
      ct: getOccurrencecount(datas(), "BOMBAY ANKLET 9.5"),
      wt: getOccurrencewt(datas(), "BOMBAY ANKLET 9.5"),
    },
    {
      id: 16,
      fname: "BOMBAY ANKLET 10",
      ct: getOccurrencecount(datas(), "BOMBAY ANKLET 10"),
      wt: getOccurrencewt(datas(), "BOMBAY ANKLET 10"),
    },
