        ...
        return {
          ...
          subtotals:
            oldnewval === editedData.type
              ? (editedData.foodItemPrices - editedData.quantitys) * editedData.rate
              : (editedData.foodItemPrices - editedData.quantitys) * editedData.rate,
...
let totalgst=  Number(values.gTotal + makingcal + (Number(hallmarkingcal)))       
  ...
  return (
     ...
     <Tooltip title="Old Silver "   arrow> 
...
<TableCell >{NumberFormat(Number(values.amountdebit))}</TableCell>
           </TableRow>
...
>
        ...
        />
         ...
         <TextField
          ...
          value={NumberFormat((editedData.foodItemPrices - editedData.quantitys) * editedData.rate)}
