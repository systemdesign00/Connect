  ...
  useEffect(() => {
    const fetchData = async () => {
      try {
        ...
        //  fetch data
        const dataUrl = `https://serdb.onrender.com/api/Items`;
...
<TableContainer component={Paper}>
    ...
    <TableCell>
        ...
        <TableCell>
              <form onSubmit={submitOrder}>
         <TextField focused size="small" style = {{width: 100}} inputProps={{ inputMode: 'numeric' }} label="tax" name="tax" id="tax" value={foodItem.tax }  onChange={handleInputChange} />
