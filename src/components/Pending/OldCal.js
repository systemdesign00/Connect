 ...
 const oldaddFoodItems = oldfoodItem => {
     ...
     const submitOrder = e => {
        e.preventDefault();
         ...
         createAPIEndpoint(ENDPIONTS.SALESOLDGOLDREPORT).salesoldgoldcreate(oldfoodItem)
                    .then(res => {
                      //audio.play()
                       //resetFormControls();
                      // resetForm()
...
const a = oldfoodItem.foodItemPrices; 
oldfoodItem.netweights = Number(oldfoodItem.foodItemPrices - oldfoodItem.lessweights)

const taxRate = ((oldfoodItem.netweights * oldfoodItem.taxs ) / 100).toFixed(3);
oldfoodItem.Tfinesss = Number((oldfoodItem.netweights * oldfoodItem.taxs ) / 100).toFixed(3);
const total =  Number(taxRate).toFixed(3) * oldfoodItem.rate;
...
<TextField focused size="small" style = {{width: 200}} label="ItemName" name="foodItemNames" id="foodItemNames" value={oldfoodItem.foodItemNames} onChange={handleInputChange} />
        ...
        <TableCell>
             <form onSubmit={submitOrder}>
          <TextField focused size="small" style = {{width: 100}} inputProps={{ inputMode: 'numeric' }} label="Gross Weight" name="foodItemPrices" id="foodItemPrices" value={oldfoodItem.foodItemPrices} onChange={handleInputChange} />
</form>
       </TableCell>
        <TableCell>
             <form onSubmit={submitOrder}>
          <TextField focused size="small" style = {{width: 100}} inputProps={{ inputMode: 'numeric' }} label="Less Weight" name="lessweights" id="lessweights" value={oldfoodItem.lessweights} onChange={handleInputChange} />
</form>
       </TableCell>
        <TableCell>
             <form onSubmit={submitOrder}>
          <TextField focused size="small" style = {{width: 100}} inputProps={{ inputMode: 'numeric' }} label="Net Weight" name="netnetweightsweight" id="netweights" value={oldfoodItem.netweights} onChange={handleInputChange} />
</form>
       </TableCell>
        <TableCell>
             <form onSubmit={submitOrder}>
           <TextField focused size="small" style = {{width: 100}} inputProps={{ inputMode: 'numeric' }} label="Finess" name="taxs" id="taxs" value={oldfoodItem.taxs} onChange={handleInputChange} />
</form>
 </TableCell>
  <TableCell>
        <form onSubmit={submitOrder}>
            <TextField focused size="small" style = {{width: 100}} inputProps={{ inputMode: 'numeric' }} label="Tfinesss" name="Tfinesss" id="Tfinesss" value={oldfoodItem.Tfinesss} onChange={handleInputChange} />
         </form>
          </TableCell> 
   <TableCell>
        <form onSubmit={submitOrder}>
