...
&nbsp;
      ...
      />
       ...
       <TableHead>
          <TableRow>
           <TableCell style={{ fontWeight: 'bold', fontSize: '1em' }}>{Data.fullName}</TableCell>
           <TableCell ></TableCell>
            <TableCell style={{ fontWeight: 'bold', fontSize: '1em' }}>{Data.mobile}</TableCell>
            <TableCell></TableCell>
              <TableCell style={{ fontWeight: 'bold', fontSize: '1em' }}>{Data.city}</TableCell>
             <TableCell></TableCell>
     
              <TableCell ></TableCell>
               <TableCell style={{ fontWeight: 'bold', fontSize: '1em' }}>{new Date(Data.hireDate).toLocaleDateString()}</TableCell>
                <TableCell ></TableCell>
 ...
 {Data?.orderPercent?.map((item,idx) => (
   // totalweigthpercent = Number(orderedFoodItemspercent.reduce((total, currentValue) => total = Number(total + currentValue.quantity),0)), 
            ...
            <TableRow key={item.id}>
              ...
              <TableCell style={{ fontWeight: 'bold', fontSize: '1.1em' }}>{item.foodItemPrice}G</TableCell>
...
<TableCell></TableCell>
 ...
 {Data?.oldorderDetails?.map((item, idx) => (
            <TableRow key={item.id}>
              ...
              <TableCell style={{ fontWeight: 'bold', fontSize: '1.1em' }}>{item.foodItemPrices}G</TableCell>
...
<TableCell></TableCell>
  ...
  <TableCell style={{ fontWeight: 'bold', fontSize: '1.1em' }}>{NumberFormat(Number(Data.gTotal))}</TableCell>
            </TableRow> 
