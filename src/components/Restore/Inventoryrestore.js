...
const handleSearchweight = e => {
  ...
  useEffect(() => {
    createAPIEndpoint(ENDPIONTS.GOLDRESTORE)
      .fetchAll()
      .then((res) => {
    ...
    if (deleting) {
      intervalId = setInterval(async () => {
        ...
        try {
          // Delete the first selected item from the API
          await axios.delete(
            `https://serdb.onrender.com/api/DelInventory/${idToDelete}`
          );
          ...
          await axios.post("https://serdb.onrender.com/api/GstGoldStock", deletedItem);
          console.log(
