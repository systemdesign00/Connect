...
export default function OrderedFoodItems(
  ...
  const stockaddremoveFoodItem = (index, id) => {
    //debugger;
    let x = { ...values };
    x.stockaddorderDetails = x.stockaddorderDetails.filter(
      (_, i) => i !== index
    );
    if (id !== 0) x.deletedOrderItemIds += id + ",";
    setValues({ ...x });
  ...
  const oldremoveFoodItemsilver = (index, id) => {
    //debugger;
    let x = { ...values };
    x.oldorderDetailsilver = x.oldorderDetailsilver.filter(
      (_, i) => i !== index
    );
    if (id !== 0) x.deletedOrderItemIds += id + ",";
    setValues({ ...x });
  ...
  const update = (idx) => {
    ...
    foodItem.subtotal =
      newval === data.type
        ? data.foodItemPrice * data.rate + Number(data.tax * data.foodItemPrice)
        : data.foodItemPrice * data.quantity * data.rate -
          (data.discount * data.foodItemPrice * data.quantity * data.rate) /
            100 +
          (data.tax * (data.foodItemPrice * data.quantity * data.rate)) / 100;
    setValues({ ...x });
    setIsEditing(false);
    //resetInputField()
  };
          ...
          return {
            ...
            subtotal:
              newval === editedDatasper.type
                ? editedDatasper.foodItemPrice * editedDatasper.rate +
                  Number(editedDatasper.tax * editedDatasper.foodItemPrice)
                : editedDatasper.foodItemPrice *
                    editedDatasper.quantity *
                    editedDatasper.rate -
                  (editedDatasper.discount *
                    editedDatasper.foodItemPrice *
                    editedDatasper.quantity *
                    editedDatasper.rate) /
                    100 +
  ...
  const oldupdatesgold = (idx, editedDatagold) => {
    setValues((prevValues) => {
      const updatedOrderDetailsgold = prevValues.oldorderDetails.map(
        (item, i) => {
          if (i === idx) {
            return {
              ...item,
              ...
              subtotals:
                oldnewval === editedDatagold.type
                  ? (editedDatagold.foodItemPrices - editedDatagold.quantitys) *
                    editedDatagold.rate
                  : (editedDatagold.foodItemPrices - editedDatagold.quantitys) *
                    editedDatagold.rate,
  ...
  const updatepercent = (idx) => {
    ...
    foodItem.subtotal =
      newval === datapercent.type
        ? datapercent.foodItemPrice * datapercent.rate +
          Number(datapercent.tax * datapercent.foodItemPrice)
        : datapercent.foodItemPrice * datapercent.quantity * datapercent.rate -
          (datapercent.discount *
            datapercent.foodItemPrice *
            datapercent.quantity *
            datapercent.rate) /
            100 +
          (datapercent.tax *
            (datapercent.foodItemPrice *
            ...
            subtotal:
              newval === editedDataper.type
                ? editedDataper.foodItemPrice * editedDataper.rate +
                  Number(editedDataper.tax * editedDataper.foodItemPrice)
                : editedDataper.foodItemPrice *
                    editedDataper.quantity *
                    editedDataper.rate -
                  (editedDataper.discount *
                    editedDataper.foodItemPrice *
                    editedDataper.quantity *
                    editedDataper.rate) /
                    100 +
  ...
  const updatefancy = (idx) => {
    ...
    foodItem.subtotal =
      newkey === datafancy.type
        ? datafancy.foodItemPrice * datafancy.rate
        : datafancy.foodItemPrice * datafancy.rate;
    setValues({ ...x });
  ...
  const updatepiece = (idx, value) => {
    ...
    //foodItem.discount = datafancy.discount
    foodItem.subtotal =
      Number(foodItem.foodItemPrice) * Number(foodItem.quantity);
    setValues({ ...x });
    setIsEditingfancy(false);
    //resetInputField()
  };
  ...
  const updatewastage = (idx) => {
    ...
    foodItem.subtotal =
      itemwastages === datawastage.type
        ? Math.round(
            (Number(datawastage.foodItemPrice) + Number(datawastage.tax)) *
              datawastage.rate
          )
        : Math.round(
            (Number(datawastage.foodItemPrice) + Number(datawastage.tax)) *
          ...
          return {
            ...
            subtotal:
              itemwastages === editedDatawast.type
                ? Math.round(
                    (Number(editedDatawast.foodItemPrice) +
                      Number(editedDatawast.tax)) *
                      editedDatawast.rate
                  )
                : Math.round(
                    (Number(editedDatawast.foodItemPrice) +
  ...
  const addupdate = (idx) => {
    ...
    foodItem.subtotal =
      additem === dataadd.type
        ? Number(dataadd.foodItemPrice) *
          (Number(dataadd.tax) + Number(dataadd.rate))
        : Number(dataadd.foodItemPrice) *
          (Number(dataadd.tax) + Number(dataadd.rate));
    setValues({ ...x });
  ...
  const oldupdatesadd = (idx, editedDataadd) => {
    setValues((prevValues) => {
      const updatedOrderDetailsadd = prevValues.addorderDetails.map(
        (item, i) => {
          if (i === idx) {
            return {
              ...item,
              ...
              subtotal:
                additem === editedDataadd.type
                  ? Number(editedDataadd.foodItemPrice) *
                    (Number(editedDataadd.tax) + Number(editedDataadd.rate))
                  : Number(editedDataadd.foodItemPrice) *
                    (Number(editedDataadd.tax) + Number(editedDataadd.rate)),
              discount: editedDataadd.discount,
            };
  ...
  const stockaddupdate = (idx) => {
    ...
    foodItem.subtotal =
      stockadditem === stockdataadd.type
        ? Number(stockdataadd.foodItemPrice) *
          (Number(stockdataadd.tax) + Number(stockdataadd.rate))
        : Number(stockdataadd.foodItemPrice) *
          (Number(stockdataadd.tax) + Number(stockdataadd.rate));
    setValues({ ...x });
  ...
  const oldupdatessadd = (idx, editedDatasadd) => {
    setValues((prevValues) => {
      const updatedOrderDetailssadd = prevValues.stockaddorderDetails.map(
        (item, i) => {
          if (i === idx) {
            return {
              ...item,
              ...
              subtotal:
                stockadditem === editedDatasadd.type
                  ? Number(editedDatasadd.foodItemPrice) *
                    (Number(editedDatasadd.tax) + Number(editedDatasadd.rate))
                  : Number(editedDatasadd.foodItemPrice) *
                    (Number(editedDatasadd.tax) + Number(editedDatasadd.rate)),
  ...
  const oldupdate = (idx) => {
    ...
    foodItem.subtotals =
      oldnewval === dataold.type
        ? (dataold.foodItemPrices - dataold.quantitys) * dataold.rate
        : (dataold.foodItemPrices - dataold.quantitys) * dataold.rate;
  ...
  const oldupdatesilver = (idx) => {
    ...
    foodItem.subtotals =
      oldnewval === dataoldsilver.type
        ? (dataoldsilver.foodItemPrices - dataoldsilver.quantitys) *
          dataoldsilver.rate
        : (dataoldsilver.foodItemPrices - dataoldsilver.quantitys) *
          dataoldsilver.rate;
  ...
  const oldupdatessilver = (idx, editedDatasilver) => {
    setValues((prevValues) => {
      const updatedOrderDetailssilver = prevValues.oldorderDetailsilver.map(
        (item, i) => {
          if (i === idx) {
            return {
              ...item,
              ...
              subtotals:
                oldnewval === editedDatasilver.type
                  ? (editedDatasilver.foodItemPrices -
                      editedDatasilver.quantitys) *
                    editedDatasilver.rate
                  : (editedDatasilver.foodItemPrices -
                      editedDatasilver.quantitys) *
                    editedDatasilver.rate,
  ...
  useEffect(() => {
    createAPIEndpoint(ENDPIONTS.PRICE)
      .fetchAll()
      .then((res) => {
        setdisplay(res.data);
      })
...
*/
  ...
  var resultadd = values.addorderDetails.reduce(
    (total, currentValue) => (total = total + currentValue.subtotal),
    0
  );
  var stockresultadd = values.stockaddorderDetails.reduce(
    (total, currentValue) => (total = total + currentValue.subtotal),
    0
  );
  var resultswastage = 0;
  var resultfancy = Number(
    values.fancyitems.reduce(
      (total, currentValue) => (total = total + Number(currentValue.subtotal)),
      0
    )
  );
  var result = 0;
  ...
  var addpercent = values.orderPercent.reduce(
    (total, currentValue) => (total = total + currentValue.subtotal),
    0
  );
  var newitem =
    ...
    resultpcs +
    Number(resultadd) +
    Number(stockresultadd) +
    Number(addpercent);
  var oldsilver = values.oldorderDetailsilver.reduce(
    ...
    <Grid container spacing={2}>
      <Grid item xs={6}>
        <Paper sx={{ width: "100%", overflow: "hidden" }} elevation={3}>
          <Toolbar>
            <Typography sx={{ flex: "1 1 60%" }} variant="h6">
              NEW RECORDS
            </Typography>
 ...
 <img src="https://img.icons8.com/material/30/FAB005/increase-decimal.png"/>
            ...
            <IconButton onClick={openListnonstock}>
              <Stack>
                ...
                <Box fontWeight="bold" style={{ fontSize: 10 }}>
                  FANCY
                </Box>
              </Stack>
            </IconButton>
              ...
              <TableBody>
                      ...
                      {isEditingadd === idx ? (
                        ...
                        >
                          <TextField
                            ...
                            size="small"
                            variant="outlined"
                            value={dataadd.foodItemName}
                            onChange={(e) => addhandle(e)}
                          />
                        </form>
                      ) : (
                ...
                :
                      ...
                      <ThemeProvider theme={redTheme}>
                        <Button
                          ...
                          onClick={(e) =>
                            addremoveFoodItem(idx, adddataa.addorderDetails)
                          }
                          size="small"
                        >
                          {" "}
                ...
                {stockaddorderedFoodItems.map((stockadddataa, idx) => (
                  ...
                  >
                      ...
                      {stockisEditingadd === idx ? (
                        ...
                        >
                          <TextField
                            ...
                            size="small"
                            variant="outlined"
                            value={stockdataadd.foodItemName}
                            onChange={(e) => stockaddhandle(e)}
                          />
                        </form>
                      ) : (
                    ...
                    >
                      <Div>{stockadddataa.quantity}</Div>
                    </TableCell>
                    <TableCell
                      onClick={() => {
                        setEditingIndexsadd(idx);
                        ...
                        {stockisEditingadd === idx ? (
                          ...
                          >
                            <TextField
                              ...
                              name="foodItemPrice"
                              id="foodItemPrice"
                              value={stockdataadd.foodItemPrice}
                              onChange={(e) => stockaddhandle(e)}
                            />
                          </form>
                        ) : (
                    ...
                    >
                      {stockisEditingadd === idx ? (
                        stockadditem === stockdataadd.type ? (
                          Math.round(
                            Number(stockdataadd.foodItemPrice) *
                              (Number(stockdataadd.tax) +
                                Number(stockdataadd.rate))
                          )
                        ) : (
                          Math.round(
                            Number(stockdataadd.foodItemPrice) *
                ...
                :
                      ...
                      <ThemeProvider theme={redTheme}>
                        <Button
                          ...
                          style={{ backgroundColor: "#ffbfbf" }}
                          onClick={(e) =>
                            stockaddremoveFoodItem(
                              idx,
                              stockadddataa.stockaddorderDetails
                            )
                          }
                          size="small"
                        >
                ...
                {orderedFoodItemspercent.map((item, idx) => {
                  ...
                  resultadd = values.addorderDetails.reduce(
                    (total, currentValue) =>
                      (total = total + currentValue.subtotal),
                    0
                  );
                  ...
                  return (
                    ...
                    >
                        ...
                        {isEditingpercent === idx ? (
                          ...
                          >
                            <TextField
                              ...
                              size="small"
                              variant="outlined"
                              value={datapercent.foodItemName}
                          ...
                          {isEditingpercent === idx ? (
                            ...
                            >
                              <TextField
                                ...
                                name="foodItemPrice"
                                id="foodItemPrice"
                                value={datapercent.foodItemPrice}
                                onChange={(e) => handlepercent(e)}
                              />
                            </form>
                          ) : (
                      ...
                      >
                        {newval === item.type ? item.rate : item.rate}
                      </TableCell>
                          ...
                          newval === datapercent.type ? (
                            Math.round(
                              Number(
                                ...
                                Number(
                                  datapercent.tax * datapercent.foodItemPrice
                                )
                            )
                          ) : (
                            Math.round(
                ...
                :
                        ...
                        <ThemeProvider theme={redTheme}>
                          <Button
                            ...
                            style={{ backgroundColor: "#ffbfbf" }}
                            onClick={(e) =>
                              removeFoodItempercent(idx, item.orderDetailId)
                            }
                            size="small"
                          >
                            {" "}
                ...
                {ordereditems.map((dataa, idx) => (
                  ...
                  >
                    ...
                    >
                      {isEditingwastage === idx ? (
                        itemwastages === data.type ? (
                          Math.round(
                            (Number(datawastage.foodItemPrice) +
                              Number(datawastage.tax)) *
                              datawastage.rate
                          )
                        ) : (
                          Math.round(
                ...
                :
                      ...
                      <ThemeProvider theme={redTheme}>
                        <Button
                          ...
                          style={{ backgroundColor: "#ffbfbf" }}
                          onClick={(e) =>
                            removeFoodItemwastage(idx, dataa.orderDetailId)
                          }
                          size="small"
                        >
                          {" "}
                    ...
                    >
                      ...
                      >
                        {isEditing === idx ? (
                          newval === data.type ? (
                            Math.round(
                              Number(data.foodItemPrice * data.rate) +
                                Number(data.tax * data.foodItemPrice)
                            )
                          ) : (
                            Math.round(
                              data.foodItemPrice * data.quantity * data.rate -
                  ...
                  >
                    ...
                    >
                      {isEditingfancy === idx ? (
                        newkey === data.type ? (
                          Math.round(
                            Number(datafancy.foodItemPrice) *
                              Number(datafancy.rate)
                          )
                        ) : (
                          Math.round(
                            Number(datafancy.foodItemPrice) *
                  ...
                  >
                    ...
                    <TableCell>
                      ...
                      <ButtonGroup className={classes.buttonGroup} size="small">
                        ...
                        <Button onClick={(e) => updatepiece(idx, 1)}>+</Button>
                      </ButtonGroup>
                    </TableCell>
                    <TableCell>
                      <Div> -</Div>{" "}
            ...
            >
              ...
              <TableBody>
                ...
                <TableRow>
                  ...
                  {Math.sign(
                    values.gTotal -
                      (Number(values.gCash) + Number(values.onlinecash)) +
                      Number(values.debitcash)
                  ) === -1 ? (
                    <TableCell sx={{ color: "green", fontWeight: "600" }}>
                      {NumberFormat(Number(values.debitcash))}
                    </TableCell>
                  ) : (
                    <TableCell sx={{ color: "green", fontWeight: "600" }}>
                      {NumberFormat(Number(values.debitcash))}
              ...
              >
                <Tab
                  icon={
                    <>
                      {" "}
                      <img src={Inv} height={35} />{" "}
                      <img src={Silverjewells} height={35} />{" "}
                    </>
                  }
                  {...a11yProps(0)}
                />
                <Tab
                  icon={
                    <>
                      <img src={Inv} height={35} />{" "}
                      <img src={Fancyjewells} height={35} />
                    </>
                  }
                  {...a11yProps(1)}
                />
                <Tab
                  icon={<img src={Silverjewells} height={35} />}
                  label="SILVER"
                  {...a11yProps(2)}
                />
                <Tab
                  icon={<img src={Fancyjewells} height={35} />}
                  label="FANCY SILVER"
                  {...a11yProps(3)}
                />
              </Tabs>
            ...
            >
              ...
              <TableBody>
                    ...
                    >
                      ...
                      >
                        {isEditingold === idx ? (
                          oldnewval === dataold.type ? (
                            Math.round(
                              (dataold.foodItemPrices - dataold.quantitys) *
                                dataold.rate
                            )
                          ) : (
                            Math.round(
                ...
                {oldorderedFoodItemssilver.map((item, idx) => {
                  oldresultsilver = values.oldorderDetailsilver.reduce(
                    (total, currentValue) =>
                      (total = total + currentValue.subtotals),
                    0
                  );
                    ...
                    >
                        ...
                        {isEditingoldsilver === idx ? (
                          ...
                          >
                            <TextField
                              ...
                              size="small"
                              variant="outlined"
                              value={dataoldsilver.foodItemNames}
                              onChange={(e) => handleoldsilver(e)}
                            />
                          </form>
                        ) : (
                          <Div>{item.foodItemNames}</Div>
                          ...
                          {isEditingoldsilver === idx ? (
                            ...
                            >
                              <TextField
                                ...
                                name="foodItemPrices"
                                id="foodItemPrices"
                                value={dataoldsilver.foodItemPrices}
                                onChange={(e) => handleoldsilver(e)}
                              />
                            </form>
                          ) : (
                      ...
                      >
                        {isEditingoldsilver === idx ? (
                          oldnewval === dataoldsilver.type ? (
                            Math.round(
                              (dataoldsilver.foodItemPrices -
                                dataoldsilver.quantitys) *
                                dataoldsilver.rate
                            )
                          ) : (
                            Math.round(
                ...
                :
                        ...
                        <ThemeProvider theme={redTheme}>
                          <Button
                            ...
                            style={{ backgroundColor: "#ffbfbf" }}
                            onClick={(e) =>
                              oldremoveFoodItemsilver(idx, item.orderDetailId)
                            }
                          >
                            {" "}
                            <DeleteSweepOutlinedIcon fontSize="medium" />
              ...
              >
                ...
                <Tab
                  icon={
                    <>
                      <img src={Inv} height={35} />{" "}
                      <img src={Add} height={35} />
                    </>
                  }
                  {...a11yProps(2)}
                />
                <Tab
                  icon={<img src={Per} height={35} />}
                  label="Percentage"
                  {...a11yProps(3)}
                />
                <Tab
                  icon={<img src={Deci} height={35} />}
                  label="Wastage"
                  {...a11yProps(4)}
                />
                <Tab
                  icon={<img src={Add} height={35} />}
                  label="Plus Rate"
                  {...a11yProps(5)}
                />
              </Tabs>
          ...
          >
            ...
            <DialogContent dividers>
             ...
             <Box height='170px'>
               ...
               {/* recent used height for bill   <Box height="180px" /> */}
               <Box height="85px" />
                  <TableContainer>
                    <Table
                      sx={{ minWidth: 650 }}
                      ...
                      <TableHead>
                        <TableRow>
                          ...
                          <TableCell
                            sx={{ fontWeight: "bold", fontSize: "15px" }}
                          >
                            {new Date(values.hireDate).toLocaleDateString(
                              "en-IN",
                              {
                                day: "numeric",
                                month: "short",
                    ...
                    >
                      ...
                      <TableBody>
                        ...
                        {addorderedFoodItems.map(
                          (item, idx) => (
                            (totalweigth = Number(
                              addorderedFoodItems.reduce(
                                (total, currentValue) =>
                                  (total = Number(
                        ...
                        {orderedFoodItemspercent.map(
                          (item, idx) => (
                            (totalweigthpercent = Number(
                              orderedFoodItemspercent.reduce(
                                (total, currentValue) =>
                                  (total = Number(
                                    total + currentValue.quantity
                                  )),
                        ...
                        {orderedFoodItems.map((item, idx) => (
                          ...
                          <TableRow key={item.id}>
                            ...
                            <TableCell>
                              {" "}
                              {newval === item.type ? item.tax : item.tax + "%"}
                            </TableCell>
                            <TableCell>
                              {isEditing === idx
                                ? newval === data.type
                      ...
                      <TableBody>
                        <TableRow>
                          <TableCell sx={{ color: "blue", fontWeight: "600" }}>
                            {" "}
                            {"Debit :" + NumberFormat(Math.round(newitem))}
                          </TableCell>
                          <TableCell></TableCell>
                          <TableCell></TableCell>
                          <TableCell></TableCell>
                        ...
                        <TableRow>
                          ...
                          >
                            {NumberFormat(Number(values.gCash))}
                          </TableCell>
                          <TableCell sx={{ color: "black", fontWeight: "600" }}>
                            {NumberFormat(Number(values.gTotal) - values.gCash)}
                          </TableCell>
                        </TableRow>
                        ...
                        <TableRow>
                          <TableCell sx={{ color: "blue", fontWeight: "600" }}>
                            {values.status +
                              ":" +
                              NumberFormat(
                                Number(values.gTotal - values.gCash) -
                                  values.onlinecash +
                                  Number(values.debitcash)
                              )}
                          </TableCell>
                          ...
                          >
                            {NumberFormat(Number(values.onlinecash))}
                          </TableCell>
                          <TableCell sx={{ color: "black", fontWeight: "600" }}>
                            {NumberFormat(
                              Number(values.gTotal - values.gCash) -
...
fontWeight: "600"
                    ...
                    {(
                      Number(
                        stockaddorderedFoodItems.reduce(
                          (total, currentValue) =>
                            (total =
                              total + Number(currentValue.foodItemPrice)),
                          0
                        )
                      ) +
                      Number(
            ...
            <form id="editForm" onSubmit={handleDialogSubmitadd}>
              ...
              >
                ...
                <TextField
                  ...
                  onChange={(e) =>
                    setEditedDataadd({ ...editedDataadd, tax: e.target.value })
                  }
                />
                <TextField
                  label="RATE"
                  ...
                  onChange={(e) =>
                    setEditedDataadd({ ...editedDataadd, rate: e.target.value })
                  }
                />
                ...
                <TextField
                  ...
                  value={NumberFormat(
                    Number(
                      editedDataadd.foodItemPrice *
                        (Number(editedDataadd.rate) + Number(editedDataadd.tax))
                    )
                  )}
                />
              </Stack>
            ...
            <form id="editForm" onSubmit={handleDialogSubmitfadd}>
              ...
              >
                ...
                <TextField
                  ...
                  value={NumberFormat(
                    Number(
                      editedDatafadd.foodItemPrice *
                        (Number(editedDatafadd.rate) +
                          Number(editedDatafadd.tax))
                    )
                  )}
                />
              </Stack>
            ...
            <form id="editForm" onSubmit={handleDialogSubmitsadd}>
              ...
              >
                ...
                <TextField
                  ...
                  value={NumberFormat(
                    Number(
                      editedDatasadd.foodItemPrice *
                        (Number(editedDatasadd.rate) +
                          Number(editedDatasadd.tax))
                    )
                  )}
                />
              </Stack>
            ...
            <form id="editForm" onSubmit={handleDialogSubmitper}>
              ...
              >
                ...
                <TextField
                  ...
                  onChange={(e) =>
                    setEditedDataper({ ...editedDataper, tax: e.target.value })
                  }
                />
                <TextField
                  label="RATE"
                  ...
                  onChange={(e) =>
                    setEditedDataper({ ...editedDataper, rate: e.target.value })
                  }
                />
