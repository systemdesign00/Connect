           ...
           addFoodItem(foodItem)
                createAPIEndpoint(ENDPIONTS.SALESREPORTSILVER).salessilvercreate(foodItem)
                    .then(res => {
                     ...
                     .catch(err => console.log(err))
                     createAPIEndpoint(ENDPIONTS.GSTSALESREPORTSILVER).salessilvercreate(foodItem)
                     .then(res => {
                       //audio.play()
                        //resetFormControls();
                       // resetForm()
...
const rates =   display.map(item => (item.rate))
  //foodItem.foodItemName = "Silver Ornaments"
...
const wordify = (num) => {
   ...
   <TableCell>
        ...
        <TableCell>
          ...
          <TextField focused size="small" style = {{width: 200}}  label="ItemName" name="foodItemName" id="foodItemName" value={foodItem.foodItemName} onChange={handleInputChange} />
</form> </TableCell>
 */}
   <TableCell>
          <form onSubmit={submitOrder}>
    ...
    options={userService.ornamentitemsilver}
     freeSolo
...
/>
        ...
        <TableCell>
            <form onSubmit={submitOrder}>
          <TextField focused size="small" style = {{width: 150}} inputProps={{ inputMode: 'numeric' }} label="Weight" name="foodItemPrice" id="foodItemPrice" value={foodItem.foodItemPrice} onChange={handleInputChange} />
</form>
    ...
    <TableCell>
        <form onSubmit={submitOrder}>
      <TextField focused size="small" style = {{width: 150}} inputProps={{ inputMode: 'numeric' }} label="Rate" name="rate" id="rate" value={foodItem.rate} onChange={handleInputChange} />
       </form>
   </TableCell>
  {/* <TableCell>
