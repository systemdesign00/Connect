...
<TableContainer component={Paper}>
    ...
    <TableCell>
        ...
        <TableCell>
              <form onSubmit={submitOrder}>
         <TextField focused size="small" style = {{width: 100}} inputProps={{ inputMode: 'numeric' }} label="+Rate" name="tax" id="tax" value={foodItem.tax }  onChange={handleInputChange} />
