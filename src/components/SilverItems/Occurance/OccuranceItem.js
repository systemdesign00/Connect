     ...
     <ThemeProvider theme={theme} >
      ...
      <Table className={styles.table}>
        ...
        <TableBody>
          ...
          <TableCell><Box fontWeight="fontWeightBold" fontSize={16}>{users.joins}</Box></TableCell>
           <TableCell></TableCell>
              <TableCell ><Box fontWeight="fontWeightBold" fontSize={16}>{users.occurrence+"QTY"}</Box></TableCell>
              </TableRow>
          ))}
        </TableBody>
      </Table>
