...
export default function Pendinglist(
  ...
  const [isDialogOpenpurchasenetrate, setIsDialogOpenpurchasenetrate] =
    useState(false);
  const [editingIndexpurchasenetrate, setEditingIndexpurchasenetrate] =
    useState(null);
  ...
  const [isDialogOpenpurchaseratecut, setIsDialogOpenpurchaseratecut] =
    useState(false);
  const [editingIndexpurchaseratecut, setEditingIndexpurchaseratecut] =
    useState(null);
  ...
  const [isDialogOpenpurchasecash, setIsDialogOpenpurchasecash] =
    useState(false);
  const [editingIndexpurchasecash, setEditingIndexpurchasecash] =
    useState(null);
  ...
  const update = (idx) => {
    ...
    foodItem.Tfiness = Number(
      (Number(data.foodItemPrice - data.lessweight) * data.tax) / 100
    ).toFixed(3);
  ...
  const updatesales = (idx, editedDatasales) => {
    setValues((prevValues) => {
      const updatedOrderDetailssales = prevValues.orderDetails.map(
        (item, i) => {
          if (i === idx) {
            return {
              ...item,
              ...
              netweight: Number(
                editedDatasales.foodItemPrice - editedDatasales.lessweight
              ),
              Tfiness: Number(
                (Number(
                  editedDatasales.foodItemPrice - editedDatasales.lessweight
              ...
              subtotal:
                newval === editedDatasales.type
                  ? Number(
                      ((editedDatasales.foodItemPrice -
                        editedDatasales.lessweight) *
                        editedDatasales.tax) /
                        100
                    ) * editedDatasales.rate
                  : Number(
                      ((editedDatasales.foodItemPrice -
                        editedDatasales.lessweight) *
                        editedDatasales.tax) /
  ...
  const updates = (idx) => {
    ...
    foodItem.subtotal =
      newval === data.type
        ? data.foodItemPrice * data.rate + Number(data.tax)
        : Number(((data.foodItemPrice - data.lessweight) * data.tax) / 100) *
          data.rate;
    setValues({ ...x });
    setIsEditing(false);
  ...
  const updatesilver = (idx) => {
    ...
    foodItem.netweight = Number(
      datasilver.foodItemPrice - datasilver.lessweight
    );
    foodItem.Tfiness = Number(
      (datasilver.netweight * datasilver.tax) / 100
    ).toFixed(3);
  ...
  const updatenetrate = (idx, editedDatanetrate) => {
    setValues((prevValues) => {
      const updatedOrderDetailsnetrate = prevValues.ordersilverDetails.map(
        (item, i) => {
          if (i === idx) {
            return {
              ...item,
              ...
              netweight: Number(
                editedDatanetrate.foodItemPrice - editedDatanetrate.lessweight
              ),
              Tfiness: Number(
                (Number(
                  editedDatanetrate.foodItemPrice - editedDatanetrate.lessweight
                ) *
                  editedDatanetrate.tax) /
                  100
              ).toFixed(3),
              rate: editedDatanetrate.rate,
              discount: editedDatanetrate.discount,
              subtotal: Number(
                editedDatanetrate.foodItemPrice * editedDatanetrate.rate
              ),
            };
          }
          return item;
  ...
  const updatecashold = (idx) => {
    ...
    foodItem.netweight = Number(
      datacashitems.foodItemPrice - datacashitems.lessweight
    );
    foodItem.Tfiness = Number(
      (datacashitems.netweight * datacashitems.tax) / 100
    ).toFixed(3);
    foodItem.rate = datacashitems.rate;
    foodItem.discount = datacashitems.discount;
    foodItem.subtotal = Number(
      datacashitems.foodItemPrice * datacashitems.rate
    );
    setValues({ ...x });
  ...
  const updatepurchasenetrate = (idx, editedDatapurchasenetrate) => {
    setValues((prevValues) => {
      const updatedOrderDetailspurchasenetrate =
        prevValues.ordercashDetails.map((item, i) => {
          if (i === idx) {
            return {
              ...item,
              ...
              netweight: Number(
                editedDatapurchasenetrate.foodItemPrice -
                  editedDatapurchasenetrate.lessweight
              ),
              Tfiness: Number(
                (Number(
                  editedDatapurchasenetrate.foodItemPrice -
              ...
              subtotal: Number(
                editedDatapurchasenetrate.foodItemPrice *
                  editedDatapurchasenetrate.rate
              ),
            };
          }
          return item;
  ...
  const handleDialogSubmitpurchasenetrate = (e) => {
    ...
    updatepurchasenetrate(
      editingIndexpurchasenetrate,
      editedDatapurchasenetrate
    );
  ...
  const updatefancy = (idx) => {
    ...
    foodItem.tax = Number(
      (datafancy.foodItemPrice * 1) / datafancy.rate
    ).toFixed(3);
    foodItem.rate = datafancy.rate;
    foodItem.discount = datafancy.discount;
    foodItem.subtotal =
      newkey === datafancy.type
        ? datafancy.foodItemPrice * 1
        : datafancy.foodItemPrice * 1;
    setValues({ ...x });
  ...
  const updatepurchaseratecut = (idx, editedDatapurchaseratecut) => {
    setValues((prevValues) => {
      const updatedOrderDetailspurchaseratecut = prevValues.fancyitems.map(
        (item, i) => {
          if (i === idx) {
            return {
              ...item,
              ...
              tax: Number(
                (editedDatapurchaseratecut.foodItemPrice * 1) /
                  editedDatapurchaseratecut.rate
              ).toFixed(3),
              ...
              subtotal:
                newkey === editedDatapurchaseratecut.type
                  ? editedDatapurchaseratecut.foodItemPrice * 1
                  : editedDatapurchaseratecut.foodItemPrice * 1,
            };
          }
  ...
  const handleDialogSubmitpurchaseratecut = (e) => {
    ...
    updatepurchaseratecut(
      editingIndexpurchaseratecut,
      editedDatapurchaseratecut
    );
  ...
  const updateratecutold = (idx) => {
    ...
    foodItem.tax = Number(
      (dataratecut.foodItemPrice * 1) / dataratecut.rate
    ).toFixed(3);
    foodItem.rate = dataratecut.rate;
    foodItem.discount = dataratecut.discount;
    foodItem.subtotal =
      newkey === dataratecut.type
        ? dataratecut.foodItemPrice * 1
        : dataratecut.foodItemPrice * 1;
    setValues({ ...x });
  ...
  const updateratecut = (idx, editedDataratecut) => {
    setValues((prevValues) => {
      const updatedOrderDetailsratecut = prevValues.ratecutitems.map(
        (item, i) => {
          if (i === idx) {
            return {
              ...item,
              ...
              tax: Number(
                (editedDataratecut.foodItemPrice * 1) / editedDataratecut.rate
              ).toFixed(3),
              ...
              subtotal:
                newkey === editedDataratecut.type
                  ? editedDataratecut.foodItemPrice * 1
                  : editedDataratecut.foodItemPrice * 1,
            };
          }
          return item;
      ...
      const updatedOrderDetailscash = prevValues.pieceitems.map((item, i) => {
        if (i === idx) {
          return {
            ...
            subtotal: Number(
              editedDatacash.foodItemPrice * editedDatacash.quantity
            ),
          };
        }
        return item;
  ...
  const updatewastagecash = (idx) => {
    ...
    foodItem.subtotal =
      datawastagecash.foodItemPrice * datawastagecash.quantity;
    setValues({ ...x });
  ...
  const updatepurchasecash = (idx, editedDatapurchasecash) => {
    setValues((prevValues) => {
      const updatedOrderDetailspurchasecash = prevValues.cashitems.map(
        (item, i) => {
          if (i === idx) {
            return {
              ...item,
              ...
              subtotal: Number(
                editedDatapurchasecash.foodItemPrice *
                  editedDatapurchasecash.quantity
              ),
            };
          }
          return item;
  ...
  const oldupdate = (idx) => {
    ...
    foodItem.Tfinesss = Number(
      (Number(dataold.foodItemPrices - dataold.lessweights) * dataold.taxs) /
        100
    ).toFixed(3);
    foodItem.rate = dataold.rate;
    foodItem.discounts = dataold.discounts;
    foodItem.subtotals =
      oldnewval === dataold.type
        ? Number(
            ((dataold.foodItemPrices - dataold.lessweights) * dataold.taxs) /
              100
          ) * dataold.rate
        : Number(
            ((dataold.foodItemPrices - dataold.lessweights) * dataold.taxs) /
  ...
  const updatepurchase = (idx, editedDatapurchase) => {
    setValues((prevValues) => {
      const updatedOrderDetailspurchase = prevValues.oldorderDetails.map(
        (item, i) => {
          if (i === idx) {
            return {
              ...item,
              ...
              netweights: Number(
                editedDatapurchase.foodItemPrices -
                  editedDatapurchase.lessweights
              ),
              Tfinesss: Number(
                (Number(
                  editedDatapurchase.foodItemPrices -
                  ...
                  editedDatapurchase.taxs) /
                  100
              ).toFixed(3),
              rate: editedDatapurchase.rate,
              discounts: editedDatapurchase.discounts,
              subtotals:
                oldnewval === editedDatapurchase.type
                  ? Number(
                      ((editedDatapurchase.foodItemPrices -
                        editedDatapurchase.lessweights) *
                        editedDatapurchase.taxs) /
                        100
                    ) * editedDatapurchase.rate
                  : Number(
                      ((editedDatapurchase.foodItemPrices -
                        editedDatapurchase.lessweights) *
                        editedDatapurchase.taxs) /
  ...
  const [oldsilverListVisibilitycut, setOldsilverListVisibilitycut] =
    useState(false);
  ...
  const [datawastagecash, setDatawastagecash] = useState(
    initialFValueswastagecash
  );
  function handle(e) {
    const newdata = { ...data };
  ...
  useEffect(() => {
    createAPIEndpoint(ENDPIONTS.PURE)
      .fetchAll()
      .then((res) => {
        setdisplay(res.data);
      })
    ...
    createAPIEndpoint(ENDPIONTS.SILVER)
      .fetchAll()
      .then((res) => {
        setdisplaysil(res.data);
      })
      .catch((err) => console.log(err));
    createAPIEndpoint(ENDPIONTS.OLD_SILVER)
      .fetchAll()
      .then((res) => {
  ...
  const subtotals = values.orderDetails.reduce((prev, curr) => {
    return (
      prev +
      curr.foodItemPrice * curr.quantity * rates -
      (curr.discount * curr.foodItemPrice * curr.quantity * rates) / 100 +
      (curr.tax * (curr.foodItemPrice * curr.quantity * rates)) / 100
    );
  }, 0);
  {
...
*/
  ...
  const submitOrder = (e) => {
    ...
    if (values.id == 0) {
      ...
      createAPIEndpoint(ENDPIONTS.PURCHASESILVER)
        .fetchAll()
        .then((res) => {
  ...
  var resultpcs = 0;
  var resultpcs = values.pieceitems.reduce(
    (total, currentValue) => (total = total + currentValue.subtotal),
    0
  );
  var resultcash = 0;
  var resultcash = values.cashitems.reduce(
    (total, currentValue) => (total = total + currentValue.subtotal),
    0
  );
  var resultwastage = values.watageitems.reduce(
    (total, currentValue) => (total = total + currentValue.subtotal),
    0
  );
  var resultswastage = 0;
  var resultfancy = values.fancyitems.reduce(
    (total, currentValue) => (total = total + currentValue.subtotal),
    0
  );
  var result = 0;
  ...
  var news =
    values.oldorderDetails.reduce(
      (total, currentValue) => (total = total + currentValue.subtotals),
      0
    ) +
    resultfancy +
    resultcash;
  //var cashbalance =  values.ordersilverDetails.reduce((total, currentValue) => total = total + currentValue.subtotal,0);
  var orderpieceitemscash = values.pieceitems.reduce(
    (total, currentValue) => (total = total + currentValue.subtotal),
    0
  );
  var oldorderpieceitemscash = values.cashitems.reduce(
    (total, currentValue) => (total = total + currentValue.subtotal),
    0
  );
  var oldcashbalances = values.ordercashDetails.reduce(
    (total, currentValue) => (total = total + currentValue.subtotal),
    0
  );
  var newitem =
  ...
  var totalfinesss =
    values.orderDetails.reduce(
      (total, currentValue) => (total = total + Number(currentValue.Tfiness)),
      0
    ) +
    values.ratecutitems.reduce(
      (total, currentValue) =>
        (total =
          total + Number(currentValue.foodItemPrice * 1) / currentValue.rate),
      0
    ) +
    Number(values.cashreceivedonline);

  var totalfinessss = productspg.map((item) =>
    item.orderNumber == values.orderNumber
      ? item?.orderDetails.reduce(
          (total, currentValue) =>
            (total = total + Number(currentValue.Tfiness)),
          0
        )
      : ""
  );
  ...
  const purchasewtsilaa = transactions.map((item) =>
    item.orderNumber === values.orderNumber
      ? item.orderDetails
          ...
          .reduce(
            (total, currentValue) => total + Number(currentValue.Tfiness),
            0
          )
      : 0
  );
  ...
  const todayOrders = transactions.filter((order) =>
    order.orderDetails.some(
      (detail) =>
        new Date(detail.salesdate).toLocaleDateString() ===
  ...
  // for top previous OB
  const previousOrders = transactions.filter((order) =>
  ...
  const sumOfPreviousTfiness = previousTfinessValues.reduce(
    (sum, value) => sum + value,
    0
  );
  ...
  // for top previous OB
  const previousOrdersrc = transactions.filter((order) =>
    order.orderNumber == values.orderNumber
      ? order.ratecutitems.some(
          (detail) =>
            new Date(detail.salesdate).toLocaleDateString() !==
  ...
  const sumOfPreviousTfinessrc = previousTfinessValuesrc.reduce(
    (sum, value) => sum + value,
    0
  );
  ...
  const previousOrdersbottom = transactions.filter((order) =>
    order.orderNumber == values.orderNumber
      ? order.oldorderDetails.some(
          (detail) =>
            new Date(detail.salesdate).toLocaleDateString() !== todayDateString
        )
      : ""
  ...
  const sumOfPreviousTfinessbottom = previousTfinessValuesbottom.reduce(
    (sum, value) => sum + value,
    0
  );
  console.log("Today's Tfiness Values:", todayTfinessValues);
  ...
  // for top previous OB
  const previousOrdersorc = transactions.filter((order) =>
    order.orderNumber == values.orderNumber
      ? order.fancyitems.some(
          (detail) =>
            new Date(detail.salesdate).toLocaleDateString() !==
  ...
  const sumOfPreviousTfinessorc = previousTfinessValuesorc.reduce(
    (sum, value) => sum + value,
    0
  );
  ...
  const totalTfiness = purchasewtsilaa.reduce(
  ...
  const purchasewtsildate = productspg.map((item) =>
    item.orderNumber == values.orderNumber
      ? item?.orderDetails.reduce(
          (total, currentValue) =>
            (total = total + Number(currentValue.Tfiness)),
  ...
  let datea = purchasewtsildate?.reduce(
    (total, currentValue) => (total = total + currentValue),
    0
  );

  const purchasewtsils = productspgrc.map((item) =>
    item.orderNumber == values.orderNumber
      ? item?.ratecutitems.reduce(
          (total, currentValue) =>
            (total =
              total +
              Number(currentValue.foodItemPrice * 1) / currentValue.rate),
          0
        )
      : ""
  );
  let dateb = purchasewtsils?.reduce(
    (total, currentValue) => (total = total + currentValue),
    0
  );
  ...
  const purchasewtod = productspgod.map((item) =>
    item.orderNumber == values.orderNumber
      ? item?.oldorderDetails.reduce(
          (total, currentValue) =>
            (total = total + Number(currentValue.Tfinesss)),
          0
        )
      : ""
  );
  let aodadj = purchasewtod?.reduce(
    (total, currentValue) => (total = total + currentValue),
    0
  );

  const purchasewtf = productspgf.map((item) =>
    item.orderNumber == values.orderNumber
      ? item?.fancyitems.reduce(
          (total, currentValue) =>
            (total =
              total +
              Number(currentValue.foodItemPrice * 1) / currentValue.rate),
  ...
  const silcal = transactions.map((item) =>
    item.orderNumber == values.orderNumber
      ? item?.ordersilverDetails.reduce(
          (total, currentValue) => (total = total + currentValue.subtotal),
          0
        )
      : ""
  );
  let aa = silcal?.reduce(
    (total, currentValue) => (total = total + currentValue),
    0
  );

  const cascal = transactions.map((item) =>
    item.orderNumber == values.orderNumber
      ? item?.pieceitems.reduce(
          (total, currentValue) => (total = total + currentValue.subtotal),
          0
        )
      : ""
  );
  let bb = cascal?.reduce(
    (total, currentValue) => (total = total + currentValue),
    0
  );

  const purerate = transactions.map((item) =>
    item.orderNumber == values.orderNumber
      ? item?.orderDetails.reduce(
          (total, currentValue) => (total = total + currentValue.subtotal),
          0
  ...
  const abcd =
    new Date().toLocaleDateString != new Date().toLocaleDateString ? 0 : abcde;
  const orderc = transactions.map((item) =>
    item.orderNumber == values.orderNumber
      ? item?.ordercashDetails.reduce(
          (total, currentValue) => (total = total + currentValue.subtotal),
          0
        )
      : ""
  );
  let aoc = orderc?.reduce(
    (total, currentValue) => (total = total + currentValue),
    0
  );

  const orderci = transactions.map((item) =>
    item.orderNumber == values.orderNumber
      ? item?.cashitems.reduce(
          (total, currentValue) => (total = total + currentValue.subtotal),
          0
        )
      : ""
  );
  let bci = orderci?.reduce(
    (total, currentValue) => (total = total + currentValue),
    0
  );

  const ordercifiness = transactions.map((item) =>
    item.orderNumber == values.orderNumber
      ? item?.oldorderDetails.reduce(
          (total, currentValue) => (total = total + currentValue.subtotals),
          0
  ...
  var cashfiness = values.fancyitems.reduce(
    (total, currentValue) =>
      (total =
        total + Number(currentValue.foodItemPrice * 1) / currentValue.rate),
    0
  ...
  var adjustfinesss =
    values.oldorderDetails.reduce(
      (total, currentValue) => (total = total + Number(currentValue.Tfinesss)),
      0
    ) + Number(cashfiness);
  ...
  let Equity =
    Number(
      values.oldorderDetails.reduce(
        ...
        values.fancyitems.reduce(
          (total, currentValue) => (total = total + currentValue.subtotal),
          0
        )
    ) +
    values.cashitems.reduce(
      (total, currentValue) => (total = total + currentValue.subtotal),
      0
    );
  ...
  let netnew = productspg.map((item) =>
    item.orderNumber == values.orderNumber
      ? item?.orderDetails.reduce(
          (total, currentValue) =>
            (total = total + Number(currentValue.Tfiness)),
  ...
  let totalcash =
    Number(values.cashreceived) + Number(values.cashreceivedonline);
  ...
  const handleSelectpg = (date) => {
    ...
    let filteredrc = allProductspgrc
      .map((productrc) => ({
        ...productrc,
    ...
    let filteredod = allProductspgod
      .map((productod) => ({
        ...productod,
    ...
    let filteredoc = allProductspgoc
      .map((productoc) => ({
        ...productoc,
    ...
    let filteredci = allProductspgci
      .map((productci) => ({
        ...productci,
  ...
  const purchasewtsil = productspg.map((item) =>
    item.orderNumber == values.orderNumber
      ? item?.orderDetails.reduce(
          (total, currentValue) =>
            (total = total + Number(currentValue.Tfiness)),
  ...
  let obw = (
    Number(sumOfPreviousTfiness) +
    Number(sumOfPreviousTfinessrc) -
    (Number(sumOfPreviousTfinessbottom) + Number(sumOfPreviousTfinessorc))
  ).toFixed(3);
  let obws = (
    Number(sumOfPreviousTfiness) +
    Number(sumOfPreviousTfinessrc) +
    Number(totalfiness) -
    (Number(sumOfPreviousTfinessbottom) +
      Number(sumOfPreviousTfinessorc) +
      Number(adjustfiness))
  ).toFixed(3);
    ...
    <Grid container spacing={2}>
      <Grid item xs={6}>
        <Paper sx={{ width: "100%", overflow: "hidden" }} elevation={3}>
          <Toolbar>
            <Typography sx={{ flex: "1 1 50%" }} variant="h6">
              PURCHASE
            </Typography>
              ...
              <Grid>
                <ThemeProvider theme={blackTheme}>
                  <Button className={`${classes.root} `}>
                    <Badge
                      badgeContent={orderedFoodItems.length}
                      color="primary"
                    >
            ...
            <Tooltip title="CASH" arrow>
              <IconButton onClick={openListwastage}>
                <Stack>
                  ...
                  <Box fontWeight="bold" style={{ fontSize: 7 }}>
                    CASH
                  </Box>
                </Stack>
              </IconButton>
            ...
            >
              ...
              <TableBody>
                {oldorderedFoodItems.map((item, idx) => {
                  oldresults = values.oldorderDetails.reduce(
                    (total, currentValue) =>
                      (total = total + currentValue.subtotals),
                    0
                  );
                  oldresult = values.oldorderDetails.reduce(
                    (total, currentValue) =>
                      (total = total + currentValue.subtotals),
                    0
                  );
                        ...
                        {isEditingold === idx ? (
                          ...
                          >
                            <TextField
                              ...
                              value={dataold.foodItemNames}
                              onChange={(e) => handleold(e)}
                            />
                          </form>
                        ) : (
                      ...
                      >
                        {isEditingold === idx ? (
                          <Div>
                            ...
                            {oldnewval === dataold.type
                              ? roundTo2DecimalPoint(
                                  Number(
                                    dataold.foodItemPrices - dataold.lessweights
                                  )
                                )
                              : roundTo2DecimalPoint(
                                  Number(
                          ...
                          <Div>
                            ...
                            {oldnewval === dataold.type
                              ? roundTo2DecimalPoint(
                                  Number(item.foodItemPrices - item.lessweights)
                                )
                              : roundTo2DecimalPoint(
                                  Number(item.foodItemPrices - item.lessweights)
                                )}
                      ...
                      >
                        {isEditingold === idx ? (
                          ...
                          <Div>
                            {" "}
                            {(
                              ((item.foodItemPrices - item.lessweights) *
                                item.taxs) /
                              100
                            ).toFixed(3)}
                          </Div>
                ...
                :
                        ...
                        <ThemeProvider theme={redTheme}>
                          <Button
                            ...
                            onClick={(e) =>
                              oldremoveFoodItem(idx, item.orderDetailId)
                            }
                          >
                            {" "}
                ...
                {ordercash.map((item, idx) => {
                  resultwastage = values.watageitems.reduce(
                    (total, currentValue) =>
                        ...
                        {isEditingcash === idx ? (
                          ...
                          >
                            <TextField
                              ...
                              value={datacashitems.foodItemName}
                          ...
                          {isEditingcash === idx ? (
                            ...
                            >
                              <TextField
                                ...
                                name="foodItemPrice"
                                id="foodItemPrice"
                                value={datacashitems.foodItemPrice}
                                onChange={(e) => handlecash(e)}
                              />
                            </form>
                          ) : (
                      ...
                      >
                        <>
                          {isEditingcash === idx ? (
                            newval === item.type ? (
                              ...
                              >
                                <TextField
                                  ...
                                  name="lessweight"
                                  id="lessweight"
                                  value={datacashitems.lessweight}
                                  onChange={(e) => handlecash(e)}
                                />
                              </form>
                            )
                            ...
                            <Div>
                              {" "}
                              {newval === item.type ? "-" : item.lessweight}
                            </Div>
                          )}
                        </>
                      </TableCell>
                        ...
                        {isEditingcash === idx ? (
                          <Div>
                            ...
                            {newval === item.type
                              ...
                              : roundTo2DecimalPoint(
                                  Number(
                                    datacashitems.foodItemPrice -
                                      datacashitems.lessweight
                                  )
                                )}
                          </Div>
                        ) : (
                          <Div>
                            ...
                            {newval === item.type
                              ? "-"
                              : roundTo2DecimalPoint(
                                  Number(item.foodItemPrice - item.lessweight)
                                )}
                          </Div>
                        )}
                      </TableCell>
                        ...
                        {isEditingcash === idx ? (
                          ...
                          <Div>
                            ...
                            {newval === item.type
                              ? "-"
                              : (
                                  ((item.foodItemPrice - item.lessweight) *
                                    item.tax) /
                                  100
                                ).toFixed(3)}
                          </Div>
          ...
          :
                ...
                {orderedfancyitems.map((dataafancy, idx) => (
                  ...
                  >
                    ...
                    >
                      <Div>
                        {new Date(dataafancy.salesdate).toLocaleDateString()}
                      </Div>
                    </TableCell>
                    <TableCell
                      onClick={() => {
                      ...
                      {isEditingfancy === idx ? (
                        ...
                        >
                          <TextField
                            ...
                            value={datafancy.foodItemName}
                            onChange={(e) => handlefancy(e)}
                          />
                        </form>
                      ) : (
            ...
            <InputAdornment position="start">
             ...
             value={datafancy.rate} onChange={(e) => handlefancy(e)} />
                ...
                :
                      ...
                      <ThemeProvider theme={redTheme}>
                        <Button
                          ...
                          style={{ backgroundColor: "#ffbfbf" }}
                          onClick={(e) =>
                            removeFoodItemfancy(idx, dataafancy.orderDetailId)
                          }
                        >
                          {" "}
                          <DeleteSweepOutlinedIcon fontSize="medium" />
              ...
              noId == datapcs.foodItemId ?  <KeyOffTwoToneIcon/> :datapcs.foodItemId  }</TableCell> */}
                    ...
                    >
                      <Div>
                        {new Date(datacash.salesdate).toLocaleDateString()}
                      </Div>
                    </TableCell>
                    <TableCell
                      onClick={() => {
                      ...
                      {isEditingwastagecash === idx ? (
                        ...
                        >
                          <TextField
                            ...
                            value={datawastagecash.foodItemName}
                            onChange={(e) => handlewastagecash(e)}
                          />
                        </form>
                      ) : (
                      ...
                      {isEditingwastagecash === idx ? (
                        ...
                        >
                          <TextField
                            ...
                            value={datawastagecash.foodItemPrice}
                            onChange={(e) => handlewastagecash(e)}
                          />
                        </form>
                      ) : (
                ...
                :
                      ...
                      <ThemeProvider theme={redTheme}>
                        <Button
                          ...
                          style={{ backgroundColor: "#ffbfbf" }}
                          onClick={(e) =>
                            removeFoodItemcash(idx, datacash.orderDetailId)
                          }
                        >
                          {" "}
                          <DeleteSweepOutlinedIcon fontSize="medium" />
                        ...
                        {isEditing === idx ? (
                          <Div>
                            ...
                            {newval === item.type
                              ? "-"
                              : roundTo2DecimalPoint(
                                  Number(data.foodItemPrice - data.lessweight)
                                )}
                          </Div>
                        ) : (
                          <Div>
                      ...
                      >
                        {isEditing === idx ? (
                          newval === data.type ? (
                            ...
                            (
                              ((data.foodItemPrice - data.lessweight) *
                                data.tax) /
                              100
                            ).toFixed(3)
                          )
                ...
                :
                        ...
                        <ThemeProvider theme={redTheme}>
                          <Button
                            ...
                            style={{ backgroundColor: "#ffbfbf" }}
                            onClick={(e) =>
                              removeFoodItem(idx, item.orderDetailId)
                            }
                          >
                            {" "}
                            <DeleteSweepOutlinedIcon fontSize="medium" />
        ...
        noId == item.foodItemId ?  <KeyOffTwoToneIcon/> :item.foodItemId  }</TableCell> */}
                        ...
                        {isEditingsilver === idx ? (
                          ...
                          >
                            <TextField
                              ...
                              value={datasilver.foodItemName}
                              onChange={(e) => handlesilver(e)}
                            />
                          </form>
                        ) : (
                          <Div>{item.foodItemName}</Div>
                          ...
                          {isEditingsilver === idx ? (
                            ...
                            >
                              <TextField
                                ...
                                name="foodItemPrice"
                                id="foodItemPrice"
                                value={datasilver.foodItemPrice}
                                onChange={(e) => handlesilver(e)}
                              />
                            </form>
                          ) : (
                        ...
                        {isEditingsilver === idx ? (
                          <Div>
                            ...
                            {newval === item.type
                              ...
                              : roundTo2DecimalPoint(
                                  Number(
                                    datasilver.foodItemPrice -
                                      datasilver.lessweight
                                  )
                                )}
                          </Div>
                        ) : (
                      ...
                      >
                        {isEditingsilver === idx ? (
                          newval === datasilver.type ? (
                            Math.round(
                              datasilver.foodItemPrice * datasilver.rate +
                                Number(datasilver.tax)
                            )
                          ) : (
                            NumberFormat(
                              Math.round(
          ...
          :
                        ...
                        <ThemeProvider theme={redTheme}>
                          <Button
                            ...
                            style={{ backgroundColor: "#ffbfbf" }}
                            onClick={(e) =>
                              removeFoodItemsilver(idx, item.orderDetailId)
                            }
                          >
                            {" "}
                            <DeleteSweepOutlinedIcon fontSize="medium" />
                ...
                {orderedratecutitems.map((dataaratecut, idx) => (
                  ...
                  >
                    ...
                    >
                      <Div>
                        {new Date(dataaratecut.salesdate).toLocaleDateString()}
                      </Div>
                    </TableCell>
                    <TableCell
                      onClick={() => {
                      ...
                      {isEditingratecut === idx ? (
                        ...
                        >
                          <TextField
                            ...
                            value={dataratecut.foodItemName}
                            onChange={(e) => handleratecut(e)}
                          />
                        </form>
                      ) : (
            ...
            <InputAdornment position="start">
             ...
             value={dataratecut.rate} onChange={(e) => handleratecut(e)} />
                        ...
                        newkey === dataratecut.type ? (
                          ...
                          >
                            <TextField
                              ...
                              value={dataratecut.foodItemPrice}
                              onChange={(e) => handleratecut(e)}
                            />
                          </form>
                        ) : (
                ...
                :
                      ...
                      <ThemeProvider theme={redTheme}>
                        <Button
                          ...
                          style={{ backgroundColor: "#ffbfbf" }}
                          onClick={(e) =>
                            removeFoodItemratecut(
                              idx,
                              dataaratecut.orderDetailId
                            )
                          }
                        >
                          {" "}
              ...
              noId == datapcs.foodItemId ?  <KeyOffTwoToneIcon/> :datapcs.foodItemId  }</TableCell> */}
                    ...
                    >
                      <Div>
                        {new Date(datapcs.salesdate).toLocaleDateString()}
                      </Div>
                    </TableCell>
                    <TableCell
                      onClick={() => {
                      ...
                      {isEditingwastage === idx ? (
                        ...
                        >
                          <TextField
                            ...
                            value={datawastage.foodItemName}
                            onChange={(e) => handlewastage(e)}
                          />
                        </form>
                      ) : (
                      ...
                      {isEditingwastage === idx ? (
                        ...
                        >
                          <TextField
                            ...
                            value={datawastage.foodItemPrice}
                            onChange={(e) => handlewastage(e)}
                          />
                        </form>
                      ) : (
                ...
                :
                      ...
                      <ThemeProvider theme={redTheme}>
                        <Button
                          ...
                          style={{ backgroundColor: "#ffbfbf" }}
                          onClick={(e) =>
                            removeFoodItempiece(idx, datapcs.orderDetailId)
                          }
                        >
                          {" "}
                          <DeleteSweepOutlinedIcon fontSize="medium" />
     ...
     <SearchFoodItems
      ...
      <TabPanel value={valuetabs} index={1}>
                      ...
                      >
                        <TableHead>
                          ...
                          <TableRow>
                            ...
                            <TableCell sx={{ backgroundColor: "#c0c0c0" }}>
                              Item
                            </TableCell>
        ...
        <TableCell sx={{ fontWeight:"bold"}}>{Number(values.cashreceivedonline).toFixed(3)}G</TableCell>*/}
                                    ...
                                    <TableRow key={row.id}>
                                      ...
                                      >
                                        {row.foodItemName +
                                          "-->" +
                                          "(" +
                                          NumberFormat(row.foodItemPrice) +
                                          ")"}
                                      </TableCell>
                          ...
                          <TableRow sx={{ border: "none", boxShadow: "none" }}>
                            <TableCell
                              sx={{
                                border: "none",
                                fontWeight: "bold",
                            ...
                            >
                              Cash Bal:{NumberFormat(Number(cashbalance))}
                            </TableCell>
    ...
    */}
             ...
             <TableCell >{((item.foodItemPrice * 1) / item.rate).toFixed(3)+"G"}</TableCell>*/}
                          ...
                          <TableRow sx={{ border: "none", boxShadow: "none" }}>
                            ...
                            >
                              Cash Bal:{NumberFormat(Number(oldcashbalance))}
                            </TableCell>
                          ...
                          <TableRow sx={{ border: "none", boxShadow: "none" }}>
                            ...
                            >
                              Closing Cash Bal:
                              {NumberFormat(
                                Number(cashbalance) - Number(oldcashbalance)
                              )}
                            </TableCell>
           ...
           <TableCell sx={{ backgroundColor: "#c0c0c0"}} >Debit</TableCell>*/}
                        ...
                        <TableBody>
                          {orderedFoodItems?.map((row) => (
                            <TableRow key={row.id}>
                              <TableCell
                                sx={{ color: "#6928AB", fontWeight: "bold" }}
                              >
                                <>
                                  {new Date(row.salesdate).toLocaleDateString(
                                    "en-GB",
                              ...
                              {row.rate == 0 ? (
                                ...
                                >
                                  {row.lessweight == 0
                                    ...
                                    : row.foodItemName +
                                      "[" +
                                      Number(row.foodItemPrice) +
                                      "G-" +
                                      Number(row.lessweight) +
                                      "G]"}
                                </TableCell>
                              ) : (
                                <TableCell
                          ...
                          {orderedratecutitems?.map((row) => (
                            <TableRow key={row.id}>
                              ...
                              <TableCell
                                sx={{ color: "#6928AB", fontWeight: "bold" }}
                              >
                                {((row.foodItemPrice * 1) / row.rate).toFixed(
                                  3
                                ) + "G"}
                              </TableCell>
                              <TableCell
                            ...
                            <TableRow key={row.id}>
                              ...
                              >
                                {row.foodItemName +
                                  "-->" +
                                  "(" +
                                  NumberFormat(Math.round(row.subtotal)) +
                                  "/" +
                                  row.rate +
                                  ")"}
                              </TableCell>
                  ...
                  <TableCell >{item.foodItemPrice}</TableCell> 
                     <TableCell >-</TableCell>*/}
                          ...
                          <TableRow sx={{ border: "none", boxShadow: "none" }}>
                            ...
                            >
                              Cash:{NumberFormat(Number(cashbalance))}
                            </TableCell>
    ...
    */}
                              ...
                              {row.rate == 0 ? (
                                ...
                                >
                                  {row.lessweights == 0
                                    ...
                                    : row.foodItemNames +
                                      "[" +
                                      Number(row.foodItemPrices) +
                                      "G-" +
                                      Number(row.lessweights) +
                                      "G]"}
                                </TableCell>
                              ) : (
                                <TableCell
             ...
             <TableCell >{((item.foodItemPrice * 1) / item.rate).toFixed(3)+"G"}</TableCell>*/}
                          ...
                          <TableRow sx={{ border: "none", boxShadow: "none" }}>
                            ...
                            >
                              Cash:{NumberFormat(Number(oldcashbalance))}
                            </TableCell>
        ...
        <TableCell >{newval === item.type ? "-" : roundTo2DecimalPoint(Number(item.foodItemPrice  - item.lessweight)).toFixed(3)+"G"}</TableCell> */}
              ...
              <TableCell >{roundTo2DecimalPoint(Number(item.foodItemPrices  - item.lessweights)).toFixed(3)+"G"}</TableCell> */}
                                  ...
                                  >
                                    {(
                                      ((row.foodItemPrices - row.lessweights) *
                                        row.taxs) /
                                      100
                                    ).toFixed(3) + "G"}
                                  </TableCell>
                        ...
                        <TableRow sx={{ border: "none", boxShadow: "none" }}>
                          ...
                          <TableCell
                            ...
                            onClick={() =>
                              copyToClipBoard(
                                (
                                  Number(totalfiness) - Number(adjustfiness)
                                ).toFixed(3)
                              )
                            }
                          >
                            {(
                              Number(totaldate) - Number(adjusttotaldate)
                            ).toFixed(3)}
                            G
                            {/* (Number(values.purchasewt)+Number(values.cashreceivedonline) - Number(values.pannumber)).toFixed(3)G*/}
                          </TableCell>
              ...
              >
                <ToggleButton value="InGots">
                  <Pdf
                    ...
                    filename={`${values.shopName}.pdf`}
                  >
                    {({ toPdf }) => (
                      <PictureAsPdfOutlinedIcon onClick={toPdf} />
                    )}
                  </Pdf>
                </ToggleButton>
            ...
            <form id="editForm" onSubmit={handleDialogSubmitsales}>
              ...
              >
                ...
                <TextField
                  ...
                  value={(
                    Number(editedDatasales.foodItemPrice) -
                    Number(editedDatasales.lessweight)
                  ).toFixed(3)}
                  onChange={(e) =>
                    setEditedDatasales({
                      ...editedDatasales,
            ...
            <form id="editForm" onSubmit={handleDialogSubmitpurchase}>
              ...
              >
                ...
                <TextField
                  ...
                  value={(
                    Number(editedDatapurchase.foodItemPrices) -
                    Number(editedDatapurchase.lessweights)
                  ).toFixed(3)}
                  onChange={(e) =>
                    setEditedDatapurchase({
                      ...editedDatapurchase,
                      netweights: e.target.value,
                    })
                  }
                />
                <TextField
            ...
            <form id="editForm" onSubmit={handleDialogSubmitratecut}>
              ...
              >
                ...
                <TextField
                  ...
                  value={Number(
                    editedDataratecut.foodItemPrice / editedDataratecut.rate
                  ).toFixed(3)}
                  onChange={(e) =>
                    setEditedDataratecut({
                      ...editedDataratecut,
            ...
            <form id="editForm" onSubmit={handleDialogSubmitpurchaseratecut}>
              ...
              >
                ...
                <TextField
                  ...
                  value={Number(
                    editedDatapurchaseratecut.foodItemPrice /
                      editedDatapurchaseratecut.rate
                  ).toFixed(3)}
                  onChange={(e) =>
                    setEditedDatapurchaseratecut({
