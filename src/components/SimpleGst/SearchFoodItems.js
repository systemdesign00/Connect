...
<TableContainer component={Paper}>
    ...
    <TableCell>
        ...
        <TableCell>
          ...
          <TextField  InputProps={{
          readOnly: true
        }} focused size="small" style = {{width: 100}} label="Weight" inputProps={{ inputMode: 'numeric' }}  name="foodItemPrice" id="foodItemPrice" value={foodItem.foodItemPrice} onChange={handleInputChange} />
</form>
       </TableCell>
        ...
        <TableCell>
         ...
         <TextField    InputProps={{
          readOnly: true
        }} focused size="small" style = {{width: 100}} label="Net Price" inputProps={{ inputMode: 'numeric' }}  name="tax" id="tax" value={foodItem.tax }  onChange={handleInputChange} />
