...
*/
  ...
  useEffect(() => {
    ...
    searchKeys,
    searchKeyssiver,
    searchKeysfancysiver,
    searchKeyspiece,
    searchKeyspurchase,
    searchKeyspurchasesil,
    searchKeysp,
  ]);
  ...
  useEffect(() => {
    createAPIEndpoint(ENDPIONTS.GSESTIMATE)
      .fetchAll()
      .then((res) => {
    ...
    createAPIEndpoint(ENDPIONTS.OLDGOLDPURCHASE)
      .fetchAll()
      .then((res) => {
    ...
    createAPIEndpoint(ENDPIONTS.OLDSILVERPURCHASE)
      .fetchAll()
      .then((res) => {
  ...
  const handleSelect = (date) => {
    ...
    let filtereds = allProductspo.filter((product) => {
      let productDate = new Date(product["hireDate"]);
      return (
        productDate >= date.selection.startDate &&
        productDate <= date.selection.endDate
  ...
  const handleSelectpg = (date) => {
    ...
    let filtered = allProductspg
      .map((product) => ({
        ...product,
        oldorderDetails: product.oldorderDetails.filter((child) => {
  ...
  */
  ...
  const componentRef = useRef();
  const purchasewt = productspg?.map((item) =>
    item.oldorderDetails?.reduce(
      (total, currentValue) =>
        (total = total + Number(currentValue.foodItemPrices)),
      0
    )
  );
  console.log(
  ...
  let netpurchasewt = purchasewt?.reduce(
    (total, currentValue) => (total = total + currentValue),
    0
  );

  const purchasewtsil = productsps?.map((item) =>
    item.oldorderDetails?.reduce(
      (total, currentValue) =>
        (total = total + Number(currentValue.foodItemPrices)),
      0
  ...
  console.log(
    purchasewtsil?.reduce(
      (total, currentValue) => (total = total + currentValue),
      0
    )
  );
  let netpurchaseswt = purchasewtsil?.reduce(
    (total, currentValue) => (total = total + currentValue),
    0
  );
...
let netpurchasewtp = purchasewtp.reduce((total,currentValue) => total = total + currentValue,0); */
  ...
  const purchasewtp = productspo?.map((item) =>
    item.orderDetails?.reduce(
      (total, currentValue) =>
        (total = total + Number(currentValue.foodItemPrice)),
      0
    )
  );
  console.log(
  ...
  let netpurchasewtp = purchasewtp?.reduce(
    (total, currentValue) => (total = total + currentValue),
    0
  );

  const purchasewtps = productspo?.map((item) =>
    item.orderDetails?.reduce(
      (total, currentValue) =>
        (total =
          newval === currentValue.type
  ...
  let netpurchasewtps = purchasewtps?.reduce(
    (total, currentValue) => (total = total + currentValue),
    0
  );

  const adddatapercent = products?.map((item) =>
    item.orderPercent.reduce(
      (total, currentValue) =>
        (total = total + Number(currentValue.foodItemPrice)),
      0
    )
  ...
  console.log(
    adddatapercent?.reduce(
      (total, currentValue) => (total = total + currentValue),
      0
    )
  );
  let savedatapercent = adddatapercent?.reduce(
    (total, currentValue) => (total = total + currentValue),
    0
  );

  const adddatawastage = products?.map((item) =>
    item.watageitems?.reduce(
      (total, currentValue) =>
        (total = total + Number(currentValue.foodItemPrice)),
      0
    )
  ...
  console.log(
    adddatawastage?.reduce(
      (total, currentValue) => (total = total + currentValue),
      0
    )
  );
  let savedataadddatawastage = adddatawastage?.reduce(
    (total, currentValue) => (total = total + currentValue),
    0
  );

  const adddataadd = products?.map((item) =>
    item.addorderDetails?.reduce(
      (total, currentValue) =>
        (total = total + Number(currentValue.foodItemPrice)),
      0
    )
  ...
  let savedataadd = adddataadd?.reduce(
    (total, currentValue) => (total = total + currentValue),
    0
  );

  const pending = searchListsp?.map((item) =>
    item.orderDetails?.reduce(
      (total, currentValue) =>
        (total = total + Number(currentValue.foodItemPrice)),
      0
  ...
  console.log(
    pending?.reduce((total, currentValue) => (total = total + currentValue), 0)
  );
  let pendingcal =
    pending?.reduce(
      (total, currentValue) => (total = total + currentValue),
  ...
  const adddataaddper = products?.map((item) =>
    item.stockaddorderDetails?.reduce(
      (total, currentValue) =>
        (total = total + Number(currentValue.foodItemPrice)),
      0
    )
  ...
  console.log(
    adddataaddper?.reduce(
      (total, currentValue) => (total = total + currentValue),
      0
    )
  );
  let savedataaddper = adddataaddper?.reduce(
    (total, currentValue) => (total = total + currentValue),
    0
  );

  const adddatasilver = products?.map((item) =>
    item.orderDetails?.reduce(
      (total, currentValue) =>
        (total = total + Number(currentValue.foodItemPrice)),
      0
  ...
  console.log(
    adddatasilver?.reduce(
      (total, currentValue) => (total = total + currentValue),
      0
    )
  );
  let savedatasilver = adddatasilver?.reduce(
    (total, currentValue) => (total = total + currentValue),
    0
  );

  const adddatasilverfancy = products?.map((item) =>
  ...
  console.log(
    adddatasilverfancy?.reduce(
      (total, currentValue) => (total = total + currentValue),
      0
    )
  );
  let savedatasilverfancy = adddatasilverfancy?.reduce(
    (total, currentValue) => (total = total + currentValue),
    0
  );

  const adddatapiece = products?.map((item) =>
    item.pieceitems?.reduce(
      (total, currentValue) => (total = total + Number(currentValue.quantity)),
      0
    )
  );
  console.log(
  ...
  let savedatapiece = adddatapiece?.reduce(
    (total, currentValue) => (total = total + currentValue),
    0
  );
  ...
  const oldcalgold = products?.map((item) =>
    item.oldorderDetails?.reduce(
      (total, currentValue) =>
        (total = total + Number(currentValue.foodItemPrices)),
      0
  ...
  let saveoldcalc = oldcalgold?.reduce(
    (total, currentValue) => (total = total + currentValue),
    0
  );

  const oldsilvercalc = products?.map((item) =>
    item.oldorderDetailsilver?.reduce(
      (total, currentValue) =>
        (total = total + Number(currentValue.foodItemPrices)),
      0
    )
  ...
  console.log(
    oldsilvercalc?.reduce(
      (total, currentValue) => (total = total + currentValue),
      0
    )
  );
  let saveoldsilver = oldsilvercalc?.reduce(
    (total, currentValue) => (total = total + currentValue),
    0
  );

  //old purchase
  const oldcalgoldpurchase = products?.map((item) =>
    item.oldorderDetails?.reduce(
      (total, currentValue) =>
        (total = total + Number(currentValue.foodItemPrices)),
      0
  ...
  console.log(
    oldcalgoldpurchase?.reduce(
      (total, currentValue) => (total = total + currentValue),
      0
    )
  );
  let saveoldcalcpurchase = oldcalgoldpurchase?.reduce(
    (total, currentValue) => (total = total + currentValue),
    0
  );

  const oldsilvercalcpurchase = products?.map((item) =>
    item.oldorderDetails?.reduce(
      (total, currentValue) =>
        (total = total + Number(currentValue.foodItemPrices)),
      0
  ...
  console.log(
    oldsilvercalcpurchase?.reduce(
      (total, currentValue) => (total = total + currentValue),
      0
    )
  );
  let saveoldsilverpurchase = oldsilvercalcpurchase?.reduce(
    (total, currentValue) => (total = total + currentValue),
    0
  );
  let cashcountreceived = Number(
    products?.reduce(
      (total, currentValue) => (total = total + Number(currentValue.gCash)),
      0
    )
  );
  let cashcountonline = Number(
    products?.reduce(
      (total, currentValue) =>
        (total = total + Number(currentValue.onlinecash)),
      0
    )
  );

  let netweight =
    Number(savedatapercent) +
    Number(savedataadddatawastage) +
    Number(savedataadd) +
    Number(savedataaddper) +
    Number(pendingcal);
                        ...
                        <TableBody>
                          ...
                          >
                            ...
                            <TableCell
                              style={{ fontWeight: "600", color: "red" }}
                            >
                              {Number(netpurchasewtp).toFixed(3) -
                                netpurchasewtps +
                                "G"}{" "}
                            </TableCell>
                          </TableRow>
                        ...
                        <TableBody>
                          ...
                          >
                            ...
                            <TableCell
                              style={{ fontWeight: "600", color: "red" }}
                            >
                              {Number(savedatasilver).toFixed(3) + "G"}
                            </TableCell>
                            <TableCell style={{ fontWeight: "600" }}>
                              Whole Sales WT:
                            </TableCell>
                  ...
                  <Paper sx={{ width: "100%" }}>
                    ...
                    <TableContainer sx={{ maxHeight: 470 }}>
                      ...
                      >
                        ...
                        <TableBody>
                          {products.map((item) =>
                            item.oldorderDetailsilver.map((row) => (
                              <TableRow
                                key={row.name}
                                sx={{
                                  "&:last-child td, &:last-child th": {
                          ...
                          >
                            ...
                            <TableCell
                              style={{ fontWeight: "600", color: "red" }}
                            >
                              {netoldsilverweight.toFixed(3) + "g"}
                            </TableCell>
                          </TableRow>
                        </TableBody>
                      </Table>
                        ...
                        <TableBody>
                          ...
                          >
                            ...
                            <TableCell
                              style={{ fontWeight: "600", color: "red" }}
                            >
                              {savedatasilverfancy.toFixed(3) + "g"}
                            </TableCell>
                          </TableRow>
                        </TableBody>
                      </Table>
                            ...
                            <TableBody>
                              ...
                              >
                                ...
                                <TableCell
                                  style={{ fontWeight: "600", color: "red" }}
                                >
                                  {netoldgoldpurchase.toFixed(3) + "g"}
                                </TableCell>
                              </TableRow>
                            </TableBody>
                          </Table>
                            ...
                            <TableBody>
                              ...
                              >
                                ...
                                <TableCell
                                  style={{ fontWeight: "600", color: "red" }}
                                >
                                  {netoldsilverpurchase.toFixed(3) + "g"}
                                </TableCell>
                              </TableRow>
                            </TableBody>
                          </Table>
   ...
   <Box height='50px'>
                  ...
                  <TableContainer>
                    ...
                    <TableCell sx={{ backgroundColor: "#c0c0c0"}}  component="th" scope="row">{row.id}</TableCell>
                        <TableCell sx={{ backgroundColor: "#c0c0c0"}}>{new Date(row.salesdate).toLocaleDateString('en-US', {
    day: 'numeric',
    month: 'long',
    year: 'numeric',
  })
                        ...
                        <TableBody>
                          ...
                          >
                            ...
                            <TableCell align="right">
                              {Number(netweight).toFixed(3) + "G"}
                            </TableCell>
                            <TableCell component="th" scope="row">
                              OLD GOLD
                            </TableCell>
                            <TableCell align="right">
                              {Number(netoldgoldweight).toFixed(3) + "G"}
                            </TableCell>
                          </TableRow>
                          ...
                          >
                            ...
                            <TableCell align="right">
                              {Number(netoldsilverweight).toFixed(3) + "G"}
                            </TableCell>
                          </TableRow>
                          ...
                          >
                            ...
                            <TableCell align="right">
                              {Number(savedatasilverfancy).toFixed(3) + "G"}
                            </TableCell>
                            <TableCell component="th" scope="row">
                              WHOLE SALES
                            </TableCell>
                          ...
                          >
                            <TableCell component="th" scope="row">
                              NET CASHFLOW ---[CASH:
                              {NumberFormat(Number(cashcountreceived))} ||
                              Online:{NumberFormat(Number(cashcountonline))}]
                            </TableCell>
                            <TableCell align="right">
                              {NumberFormat(Number(totalcash))}
                            </TableCell>
                          </TableRow>
                        </TableBody>
                      </Table>
