...
<DashboardNavbar/>
     ...
     <ThemeProvider theme={theme} >
      ...
      >
       ...
       : 
          <TableCell  > 
          <Chip label={  <Box fontWeight="fontWeightBold" fontSize={16}>{users.aadhaarnumber}</Box>} onClick={() => EditOrRemoves(users)} color="success" variant="outlined" 
    ...
    />}</TableCell>
              <TableCell>
                       {/*   <ThemeProvider theme={greenTheme}>
                                         ...
                                         onClick={
                                         ()=>copyToClipBoard(users.fullName)
                                         }>
