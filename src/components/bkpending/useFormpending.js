...
export function useFormpending(getFreshModelObjectpending) {
const defaultImageSrc = "https://static.vecteezy.com/system/resources/previews/002/265/650/large_2x/unknown-person-user-icon-for-web-vector.jpg";
    const [values, setValues] = useState(getFreshModelObjectpending());
    ...
    const resetFormControls = () => {
        setValues(getFreshModelObjectpending());
        setErrors({})
    }
