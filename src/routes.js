...
import Pendingold from "components/Pendingold/Mainpending";
import Stocksegister from "components/StockRegister";
import AddItems from "components/AddOrderItem/AddItem";
import OrderItems from "components/OrderItems/Mainordersearch";
import BKpending from "components/bkpending/Mainpending";
// @mui icons
...
const routes = [
  ...
  {
    // type: "collapse",
    name: "Whole Sale@Old_Ver",
    key: "Outblackold",
    icon: <FaUserSecret />,
    route: "/Outblackold",
    component: <Pendingold />,
  },
  {
    //type: "collapse",
    name: "BkPending",
